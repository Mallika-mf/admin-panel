                         ...
                         orders.UserId.includes(searchTerm)).map((item,id)=>{
                                 return(
                                     <tr key={id}>
                                         ...
                                         <td className=""><img src={item.Doc1}  width="50px" height="50px"/></td>
                                         <td className=""><img src={item.Doc2}  width="50px" height="50px"/></td>
                                         <td className=""><img src={item.Doc3}  width="50px" height="50px"/></td>
                                         <td className=""><img src={item.Doc4}  width="50px" height="50px"/></td>
                                         <td className=""><img src={item.Doc5}  width="50px" height="50px"/></td>
                                         <td className=""><img src={item.Doc6}  width="50px" height="50px"/></td>
                                         <td className=""><img src={item.Doc7}  width="50px" height="50px"/></td>
