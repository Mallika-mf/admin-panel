...
const override = css`
  ...
  border-color: red;
`;
const SubscriptionAssignedTable = () => {
    const [show,setShow] = useState(true)
    return (
        <Fragment>
            <BreadCrumb parent={<Home/>} subparent="Order Management" title="Subscriptions Assigned"/>
                                ...
                                <Table>
                                    <thead>
                                        <tr>
                                            ...
                                            <th scope="col">Meals Used</th>
                                            <th scope="col">Meals Available</th>
                                        </tr>
                                    </thead>
                                    <tbody>
                                        {/* <tr>
...
export default SubscriptionAssignedTable;