                    ...
                    <div className="card">
                      <div class="card-body text-center">
                        ...
                        <p className="text-left">
                          ...
                          amazing awards and rewards according to your delivery
                          ratings.
                          <br />
                        </p>
                      </div>
                  ...
                  >
                    <div className=" icon-box-fourteen ">
                      <p className="m-top-0 p-top-0 text-left">
                        ...
                        Well, we believe that our happiness lies in yours, which
                        makes us go any mile to keep you happy and sound.
                        <br />
                    ...
                    <div className="card" style={{ border: "none" }}>
                      <div class="card-body text-center">
                        ...
                        <p style={{ textAlign: "justify" }}>
                          ...
                          done yet. The best performer will be rewarded rightly
                          <br />
                        </p>
                      </div>
                    </div>
                  ...
                  >
                    ...
                    <div className=" icon-box-fourteen text-center">
                      ...
                      >
                        ...
                        towards being awesome. Based on the ratings and reviews
                        by our customers, we’ll announce one of the delivery
                        partners as M-Food Star ride and award them with
                        super-cool gifts or brand vouchers like Flipkart,
                        Amazon, Myntra, etc
                      </p>
                    </div>
                    {/*<!-- ends: .icon-box -->*/}
