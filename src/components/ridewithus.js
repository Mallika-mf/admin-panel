              ...
              <div className="row">
                <div className=" col-lg-7">
                  <h1
                    ...
                    style={{ marginTop: "-70%", fontWeight: 400 }}
                  >
                    Drive With Us
                  </h1>
                  <p className="text-left" style={{ fontSize: "15px" }}>
                    As much as the chef partners are essential to cook the
                    delicious food, driver-partners are vital to delivering that
                    food to the destination right on time.
                  </p>
              ...
              <div className="row" style={{ margin: "auto" }}>
                ...
                >
                  ...
                  <div className=" icon-box-fourteen text-left">
                    ...
                    satisfying the taste buds of the customers from excellent
                    home chefs and deliver the food on-time no matter what,
                    we’re in need of you. Your act of serving people will be
                    noticed and appreciated. To give you a little push towards
                    your dreams, to let you pay the fee of your college, to
                    provide you with the ability to take care of your family,
                    MothersFood has come up with as many benefits as possible,
                    while you enjoy taking a ride in the city and delivery the
                    finger-licking food to the customers.
                  </div>
                </div>
              </div>
            </div>
                  ...
                  <div className="card">
                    <div class="card-body text-center">
                      ...
                      <p className="text-left">
                        Customer satisfaction is what we aim for-good food with
                        good delivery services. Ride with us and earn amazing
                        awards and rewards according to your delivery ratings.
                        <br />
                      </p>
                    </div>
                  </div>
                ...
                <div className="col-lg-4 col-md-6">
                  <div className="card">
                    <div class="card-body text-center">
                      ...
                      <p className="text-left">
                        Emergency and unpredictable situations are unavoidable.
                        MothersFood provides insurance for all our delivery
                        partners to support their families in hard times.
                        <br />
                      </p>
                    </div>
                  </div>
                  ...
                  <div className="card">
                    <div class="card-body text-center">
                      ...
                      <p className="text-left">
                        ...
                        MothersFood family. MothersFood kit- t-shirt, cap, bag
                        is a small gesture from our side to show that you are
                        family.
                        <br />
                      </p>
                    </div>
              ...
              <div className="row" style={{ margin: "auto" }}>
                ...
                >
                  <div className=" icon-box-fourteen ">
                    <p className="m-top-0 p-top-0 text-left">
                      Sounds exciting? Don’t wait anymore. Register with us now
                      and start your exciting journey with MothersFood. Well, we
                      believe that our happiness lies in yours, which makes us
                      go any mile to keep you happy and sound.
                      <br />
                      ...
                      assignments. That’s it. You can get on board with no other
                      possessions.
                    </p>
                  </div>
                </div>
                  ...
                  <div className="card" style={{ border: "none" }}>
                    <div class="card-body text-center">
                      ...
                      <p style={{ textAlign: "justify" }}>
                        ...
                        M-Food’s attractive incentive program will appreciate
                        every milestone to keep you right on track.
                        <br />
                      </p>
                    </div>
                  </div>
                ...
                <div className="col-lg-6 col-md-6">
                  <div className="card" style={{ border: "none" }}>
                    <div class="card-body text-center">
                      ...
                      <p style={{ textAlign: "justify" }}>
                        There’s nothing that matters to you more than your job?
                        MothersFood considers several factors like average
                        delivery time, no. Of order completed in a month,
                        previous month performance, and a lot more things and
                        announces the tremendous performing Driver-partners as
                        Best performers. Wait, we’re not done yet. The best
                        performer will be rewarded rightly
                        <br />
                      </p>
                    </div>
                  </div>
              ...
              <div className="row" style={{ margin: "auto" }}>
                ...
                >
                  ...
                  <div className=" icon-box-fourteen text-center">
                    ...
                    >
                      If our customers love your service, so do we. The more the
                      positive ratings you get, the closer you move towards
                      being awesome. Based on the ratings and reviews by our
                      customers, we’ll announce one of the delivery partners as
                      M-Food Star ride and award them with super-cool gifts or
                      brand vouchers like Flipkart, Amazon, Myntra, etc
                    </p>
                  </div>
                  {/*<!-- ends: .icon-box -->*/}
                </div>
