...
class MfCash extends React.Component {
  state = {
                      ...
                      <div className="cardbody p-2">
                        <ul className="bullet--list2">
                          <li className="bullet_list">
                            <b>Redeem your MF Cash on all orders</b>
                          </li>
                          <li className="bullet_list">
                            <b>
                        ...
                        return (
                          <div key={index}>
                            <div
                              ...
                              style={{ marginTop: "5%", background: "#FBFBFC" }}
                            >
...
export default connect(mapStateToProps)(MfCash);
