                   ...
                   <select className="form-control" value={maritialStatus} onChange={onChangeMaritialStatus} id="gender">
                    ...
                    <div className="clearfix"></div>
                     ...
                     <div class="col-sm-2">
                       {passbookUrl===""?
                         <a></a>:
                         <a href={passportUrl}  id="a2" target="_blank">View</a>
                       }
                        </div>
                    </Row>
                    ...
                    <div className="clearfix"></div>
                     ...
                     {rcUrl===""?
                         <a></a>:
                         <a href={rcUrl}  id="a2" target="_blank">View</a>
                        }
                        </div>
                    </Row>
                    ...
                    <div className="clearfix"></div>
                     ...
                     {drivingUrl===""?
                         <a></a>:
                         <a href={drivingUrl}  id="a2" target="_blank">View</a>
                        }
                        </div>
                    </Row>
                    ...
                    <div className="clearfix"></div>
                     ...
                     {insurenceCopyUrl===""?
                         <a></a>:
                         <a href={insurenceCopyUrl}  id="a2" target="_blank">View</a>
                        }
                        </div>
                    </Row>
                                ...
                                <Table id="datatable"  data-toolbar="#bootstrap-table-toolbar" className="datatables-demo table table-striped table-bordered" style={{tablelayout: "auto;"}}>
                                    <thead >
                                        <tr>
                                            ...
                                            <th scop="col" >MobMobileNumber </th>
                                            <th scop="col"> City	</th>
