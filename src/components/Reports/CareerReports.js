...
const CareerReports = (props) => {
    ...
    useEffect(()=>{
        try{
            ...
            database.ref().child("Referrals").child("Resumes")       
...
var database = app.database();
database.ref().child("Referrals").child("Resumes")      // back here
       ...
       return (
        <Fragment>
            ...
            <Container fluid={true}>
                ...
                table="datatable"  
                filename="CareerReport"  
                sheet="CareerReport"  
                buttonText="Excel" />
                <iframe
                    id="iDatatable"
                    src="/reports/career-report"
                    style={{ display: 'none' }}
                    title="Receipt"
                />
                                            ...
                                            orders.MobileNumber.includes(state.search)).map((item,id)=>{
                                                if(item.Photo==""){
                                                    return(
                                                       ...
                                                       <td className="">{"Not Uploaded"}</td>
                                                       <td className="">{item.UniversityName}</td>
                                                       <td className="">{item.Degree}</td>
                                                       <td className="">{item.GPA}</td>
                                                       <td className="">{item.Position}</td>
                                                       <td className=""><a href={item.Resume} target="_blank">{"View"}</a></td>
                                                       <td className="">{item.Additional}</td>
                                                    ...
                                                    return(
                                                       ...
                                                       <td className="">{item.Title}</td>
                                                       <td className=""><a href={item.Photo} target="_blank">{"View"}</a></td>
                                                       <td className="">{item.UniversityName}</td>
                                                       <td className="">{item.Degree}</td>
                                                       <td className="">{item.GPA}</td>
                                                       <td className="">{item.Position}</td>
