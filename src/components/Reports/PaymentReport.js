                ...
                <Row>
                  ...
                  <Row>
                    ...
                    <div className="form-group col-md-6">
                         <label htmlFor="paymentNumber" className="form-label">Search <span style={{color: "red"}}>*</span></label>
                         <input type="text" id="paymentNumber"  value={searchTearm} onChange={onChangeHandler}  required=""   className="form-control" placeholder="Search for number" title="Type in a name"/>
                 ...
                 {isLoading ? 'Print' : 'Print Receipt'}
                            ...
                            <div className="table-responsive text-nowrap">
                                <Table id="datatable">
                                    ...
                                    <tbody>
                                    {users.filter(orders =>
                                            orders.MobileNumber.includes(searchTearm)).map((item,id)=>{
                                                    return(
                                                        <tr key={id}> 
                                                        <td>{id+1}</td>       
