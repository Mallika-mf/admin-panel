        ...
        >
          ...
          >
            <img
              ...
              style={{ maxWidth: "500px", height: "450px", marginLeft: "60%" }}
              alt=""
            />
          </div>
            ...
            <div className="container">
              <div className="row">
                <div className="col-lg-7">
                  <h1 className="display-3 text-left">Partner With Us</h1>
                  <p className="text-left">
                    Empowering women with the wonderful cooking skills to spread
                    their talent and earn money{" "}
                  </p>
                ...
                >
                  ...
                  <div className=" icon-box-fourteen text-left">
                    <p className="m-top-0 p-top-0 text-left">
                      Either choose to sit at home and cry for attention, or get
                      on board to rock your kitchen and be successful, being
                      awesome is your own choice.
                    </p>
                    <ul className="bullet--list2">
                      <li className="bullet_list text-left">
                        What’s something that you can cook like no one else can?
                      </li>
                      <li className="bullet_list text-left">
                        What are your splendid dishes that your family wars for
                        a bigger piece?
                      </li>
                      <li className="bullet_list text-left">
                        {" "}
              ...
              <div className="row">
                <div className="col-lg-8 offset-lg-2 section-title text-center">
                  ...
                  <p>
                    ...
                    excellent features that didn’t exist in the market to date.
                  </p>
                </div>
                <div className="col-lg-4 col-md-6">
                  <div className="card">
                    <div class="card-body text-center">
                      ...
                      <p className="text-left">
                        You don’t have to have a complete menu to work with us.
                        If you can make only one dish that everyone loves,
                  ...
                  <div className="card">
                    <div class="card-body text-center">
                      ...
                      >
                        ...
                        relax, our delivery partners make sure to take it to the
                  ...
                  <div className="card">
                    <div class="card-body text-center">
                      ...
                      >
                        ...
                        permissions anymore. As per your state laws, we’ll stack
                        everything required to start you off.
                        <br />
                      </p>
                    </div>
                  </div>
              ...
              <div className="row" style={{ margin: "auto" }}>
                ...
                >
                  ...
                  <div className=" icon-box-fourteen text-center">
                    ...
                    >
                      We believe in recognizing the talents that are impeccable
                      at their job. To bring it to reality, we’ve come up with
                      “M-Food Star Chef Recognition” to keep your competitive
                      spirit motivated. Once in a month, we’ll evaluate your
                      performance based on the customer ratings, your efficiency
                      to finish an order smoothly, and several other factors and
                      announce our best chef-partner as “M-Food Star Chef” of
                      that specific month. <br />
                      This will help you improve your rating as the best chef in
                      your area and more likely to be recognized by more people.
                      So, as John Wooden says, make each day your masterpiece
                    </p>
                  </div>
                  {/*<!-- ends: .icon-box -->*/}
                </div>
                ...
                >
                  ...
                  <div className=" icon-box-fourteen ">
                    <p className="m-top-0 p-top-0 text-left">
                      ...
                      they already tasted and liked it much. Makes sense. Right?
                      If you get a customer of that kind, we’ll be happy to be a
                      part of your growth. <br />
              ...
              <div className="row" style={{ margin: "auto" }}>
                ...
                >
                  ...
                  <div className=" icon-box-fourteen text-justify">
                    <p className="m-top-0 p-top-0 text-left">
                      Our customers will get to rate the taste once the order is
                      completed. The chef-partners who strive to satisfy the
                      taste-buds of our customers, we’ve got something for you
                      too. Every month we’ll evaluate the taste ratings and
                      announce one chef-partner with a High-taste rating as the
                      winner. The winner will receive many exciting prizes like
                      Microwave oven, Mini Refrigerators, Cutlery set, and a lot
                      more worth of 5,000 to 10,000. Sounds exciting. Right?
                    </p>
                  </div>
                  {/*<!-- ends: .icon-box -->*/}
                </div>
                ...
                >
                  ...
                  <div className=" icon-box-fourteen text-justify">
                    <p className="m-top-0 p-top-0 text-left">
                      ...
                      chef-partners happy b. In the process, we came up with an
                      M-food Grocery store, where you can buy all the required
                      groceries to save more than usual. How is it different
                      from buying from local markets or other supermarkets
                      around? We’ve established connections with brands directly
                      to get groceries for the best possible deals. So, all the
                      wholesale or retail charges are grounded, and you can take
                      the complete benefit of it.
                    </p>
                  </div>
                  {/*<!-- ends: .icon-box -->*/}
                </div>
