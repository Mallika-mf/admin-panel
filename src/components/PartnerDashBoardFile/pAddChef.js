...
app.database().ref().child("Masters").child("SubLocalities")
  ...
  // }
    ...
    const cateringServiceChange=(event)=>{
      cateringService(event.target.checked)
    }
                    ...
                    <Col sm="12">
                      ...
                      {/* <span> Use a class <code> table </code> to any table.</span> */}
                       ...
                       <label className="form-label">Email Id <span style={{color: "red"}}>*</span></label>
                        ...
                        <Button className="btn btn-primary"  id="verify-code-button" onClick={onVerifyCodeSubmit} style={{color: "white",fontFamily: 'Cinzel',fontWeight: "bold"}} onClick={onVerifyCodeSubmit} >Verify</Button>	
                        </Col>
                        ...
                        <Col className="col-sm-10">
                        <Input type="file" id="doc1" className="form-control" />
                        <div className="clearfix"></div>
                         </Col>
                        </Row>
