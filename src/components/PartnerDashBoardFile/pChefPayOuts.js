                                            ...
                                            orders.UserId.includes(searchTerm)).map((item,id)=>{
                                                    return(
                                                     ...
                                                     <td class="item_locality">{cName[cPushId.indexOf(item.City)]}</td>
                                                       ...
                                                       <td class="actions" style={{textAlign:"center"}}><a href="#" className="update-row"><Save id={item.UserId} size={15}/></a></td>
                                                     </tr> 
                                                    )
                                        ...
                                        {users.map((item,id)=>{
                                                    return(
                                                     ...
                                                     <td class="item_locality">{cName[cPushId.indexOf(item.City)]}</td>
                                                       ...
                                                       <td class="actions" style={{textAlign:"center"}}><a href="#" className="update-row"><Save size={15}/></a></td>
                                                     </tr> 
                                                    )
