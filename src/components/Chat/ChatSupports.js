        ...
        <div className="chat-sidebox col">
            ...
            <div className="flex-grow-0 px-4" style={{width:"300px"}}>
                <div className="media align-items-center">
                    ...
                    <a  className="chat-sidebox-toggler d-lg-none d-block text-muted text-large font-weight-light pl-3">&times;</a>
                </div>
            ...
            <div className="flex-grow-1 position-relative">
                ...
                {users.filter(x => x.Name.includes(searchKeyword)).map((item, i) => {
                                         item.sn++
                                    return (
                    ...
                    {contacts.map((item,id)=>{
                        return(
                            <div key={id}>
                                ...
                                <div className="text-muted small text-nowrap mt-2" ></div></div>
                                <div className="flex-shrink-1 bg-lighter rounded py-2 px-3 ml-3"style={{backgroundColor:" #F8F8F8",marginRight:"70px"}}><img src={item.Text}  width="250px"   />
                                {item.Date+','+item.Time}</div></div>
                               :item.Type=="Text"?
                                ...
                                {item.Date+','+item.Time}</div></div>:
                                 <div className=" mb-4 media align-items-center"><div><img src={images} style={{height:"40px",width:"40px"}} className="ui-w-40 rounded-circle" alt=""></img>
                                 <div className="text-muted small text-nowrap mt-2"></div></div>
                                 <div className="flex-shrink-1 bg-lighter rounded py-2 px-3 ml-3"style={{backgroundColor:" #F8F8F8"}}><img src={item.Text} width="250px" className=" img-responsive" />
                                 {item.Date+','+item.Time}</div></div>
                            }
                            </div>
                        )
