        ...
        <div className="container">
          <div className="row">
            <div className="col-lg-12">
              <div className="mb-5">
                <div
                  className="divider divider-simple text-center"
                  style={{ marginTop: "-2%" }}
                >
                ...
                <div className="m-bottom-40">
                  <ul className="bullet--list2" style={{ fontSize: "15px" }}>
                    ...
                    >
                      ...
                      collectively refer to MothersFood and the terms "You"
                    ...
                    >
                      ...
                      you and MothersFood (both terms defined below). The terms
                      of this Privacy Policy will be effective upon your
                      acceptance of the same (directly or indirectly in
                      electronic form, by clicking on the I accept tab or by use
                      of the website or by other means) and will govern the
                      relationship between you and MothersFood for your use of
                    ...
                    >
                      ...
                      and sensitive personal data of information) rules, 2011
                      under Information Technology Act, 2000; that require
                    ...
                    >
                      ...
                      consent to this Privacy Policy. If you do not agree with
                    ...
                    >
                      ...
                      the collection, storage, processing and transfer of any or
                      all of Your Personal Information and Non-Personal
                ...
                <div className="m-bottom-40">
                  <ul className="bullet--list2">
                    ...
                    >
                      ...
                      required to provide certain information for the
                      registration process namely: - a) your name, b) email
                      address, c) sex, d) age, e) PIN code, f) credit card or
                      debit card details g) medical records and history h)
                      sexual orientation, i) biometric information, j) password
                      etc., and / or your occupation, interests, and the like.
                    ...
                    >
                      ...
                      use the above said user information to, maintain, protect,
                      and improve its services (including advertising services)
                    ...
                    >
                      ...
                      is furnished under the Right to Information Act, 2005 or
                ...
                <div className="m-bottom-40">
                  <ul className="bullet--list2">
                    ...
                    >
                      ...
                      we may use "cookies", or similar electronic tools to
                      ...
                      can contain is information you supply (an example of this
                      is when you ask for our Personalised Horoscope). A cookie
                      cannot read data off your hard drive. Our advertisers may
                      also assign their own cookies to your browser (if you
                    ...
                    >
                      ...
                      about your computer's connection to the Internet,
                      including your IP address, when you visit our site. (Your
                      IP address is a number that lets computers attached to the
                      Internet know where to send you data -- such as the web
                      pages you view.) Your IP address does not identify you
                      personally. We use this information to deliver our web
                      pages to you upon request, to tailor our site to the
                      interests of our users, to measure traffic within our site
                      and let advertisers know the geographic locations from
              ...
              <div className="post-body">
                ...
                <div className="m-bottom-40">
                  <p style={{ textAlign: "justify", fontSize: "15px" }}>
                    ...
                    responsible in way for your use of such sites.
                  </p>
                </div>
              </div>
                  ...
                  <p style={{ textAlign: "justify", fontSize: "15px" }}>
                    ...
                    <ul className="bullet--list2">
                      ...
                      >
                        ...
                        or governmental agency or authority to disclose, for the
                        purpose of verification of identity, or for the
                        ...
                        enforcing these Terms; for complying with the applicable
                      ...
                      >
                        ...
                        companies and officers and employees of such group
                        companies for the purpose of processing personal
                        information on its behalf. We also ensure that these
                        recipients of such information agree to process such
                ...
                <div className="m-bottom-40">
                  <ul className="bullet--list2">
                    ...
                    >
                      ...
                      unauthorized access to systems where we store personal
                      data.{" "}
                    </li>
                    <li
                      style={{ textAlign: "justify", fontSize: "15px" }}
                    ...
                    >
                      ...
                      servers secured behind a firewall; access to the servers
                      ...
                      the Internet. And, of course, any information you include
                      in a posting to the discussion areas is available to
              ...
              <div className="post-body">
                ...
                <div className="m-bottom-40">
                  <p style={{ textAlign: "justify", fontSize: "15px" }}>
                    ...
                    Officer as mentioned below via in writing or through email
                  ...
                  <p style={{ textAlign: "justify", fontSize: "15px" }}>
                    ...
                    <br />
                    A-49, Ground Floor, Ashirwad Building, Street-3,
                    Prakashnagar,
                    <br />
                    Begumpet, Secunderabad, Telangana - 500003 <br />
                    Email: srikanth@mothersfood.in
                    <br />
                    Ph: +91 910091 8669
                    <br />
                  </p>
