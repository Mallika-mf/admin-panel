...
const WorkingPartnerTransactionHistory = () => {
  ...
  const onClickSearchBox = (event) => {
    ...
    app.database().ref().child("Franchise").orderByChild("UserId").equalTo(searchBox)
  ...
  return (
    <Fragment>
      <BreadCrumb parent={<Home />} subparent="Payouts" title="Working Partner Transaction History" />
      <Container fluid={true}>
        <Row className="form-row" style={{ marginTop: "3%" }}>
          <Col className="form-group col-md-6">
            <label className="form-label">Enter Working Partner Number</label>
            <Row>
        ...
        <Row>
          <Col sm="12">
            <CardHeader>
              <h6> Working Partner Transaction History</h6>
        ...
        <div className="col-md-11 text-right" style={{ margin: "2%" }}>
          <div className="dt-buttons btn-group">
            ...
            <ReactHTMLTableToExcel
              ...
              table="data-table"
              filename="WorkingPartnerTransectionHistory"
              sheet="WorkingPartnerTransectionHistory"
              buttonText="Excel" />
            <iframe
              id="iDatatable"
              src="/payouts/working-partner-transaction-history"
              style={{ display: 'none' }}
              title="Receipt"
            />
              ...
              <Table id="data-table" className={classes.table}  >
                <TableHead >
                  <TableRow>
                    ...
                    <TableCell scop="col">Working Partner Id</TableCell>
                    <TableCell scop="col">Working Partner Name</TableCell>
