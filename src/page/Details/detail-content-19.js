    ...
    return (
        <Fragment>
            ...
            <br />
                        ...
                        <p style={{ textAlign: "justify",fontSize: "15px" }}><b>2)Broccoli:</b></p>
                        ...
                        <p style={{ textAlign: "justify",fontSize: "15px" }}><b>3)Fenugreek:</b></p>
                        ...
                        <p style={{ textAlign: "justify",marginLeft:"2%",fontSize: "14px" }}>-Menopause issues</p>
                        <p style={{ textAlign: "justify",marginLeft:"2%",fontSize: "14px" }}>-Arthritis Palms</p>
                        <p style={{ textAlign: "justify",marginLeft:"2%",fontSize: "14px" }}>-Malfunctioning of Kidney</p>
                        <p style={{ textAlign: "justify",marginLeft:"2%",fontSize: "14px" }}>-Digestive disorders</p>
                        <p style={{ textAlign: "justify",marginLeft:"2%",fontSize: "14px" }}>-Skin and Hair problems. </p>
                        <p style={{ textAlign: "justify",marginLeft:"2%",fontSize: "14px" }}>The best way to include methi in regular diet is to have it in the form of kasuri methi or seeds.During winter season one can also consume it in the form of vegetable that is cooked and also in the form of roti/parathas/theplas.<br /></p>



                        <p style={{ textAlign: "justify",fontSize: "15px" }}><b>4)Curry Leaves/Sweet Neem:</b></p>
                        <p style={{ textAlign: "justify",marginLeft:"2%",fontSize: "14px" }}>
