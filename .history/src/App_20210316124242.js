...
import NewsDetail24 from "./page/news-detail-24";
import NewsDetail25 from "./page/news-detail-25";
    ...
    return (
      <>
        ...
        <Switch>
          ...
          <Route exact path="/news-detail-24" component={NewsDetail24} />
          <Route exact path="/news-detail-25" component={NewsDetail25} />
