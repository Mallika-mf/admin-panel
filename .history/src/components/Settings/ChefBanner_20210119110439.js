   ...
   const onChangeHandler=(event)=>{
    ...
    const onDrop = (event) => {
        ...
        if(image === '' ) {
          ...
          const uploadTask = storage.ref("/ChefDetailsChefBanner/").child(name).put(image,metadata)
          ...
          (snapShot) => {
            ...
            storage.ref("/ChefDetailsChefBanner/").child(name).getDownloadURL()
             .then(fireBaseUrl => {
    ...
    const onSubmitHandler=(event)=>{
      ...
      var firebaseref=app.database().ref().child("AppContent").child("ChefDetailsChefBanner")
