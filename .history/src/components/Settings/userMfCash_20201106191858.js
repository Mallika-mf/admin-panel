...
const onSubmit=(event)=>{
    ...
    if (person === password) {
        ...
        var firebaseref1=app.database().ref().child("Users").child(phoneNumber).child("Wallet");
        ...
        firebaseref1.transaction(function(currentstock) {
           ...
           return currentstock;
             ...
             function(error, committed, snapshot) {
                a=snapshot.val();
                console.log(a);
                var ref=app.database().ref().child("Users").child(phoneNumber).child("Transactions").push();
                ...
                ref.child("UserId").set(String(phoneNumber));
