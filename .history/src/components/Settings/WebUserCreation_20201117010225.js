...
const WebUserCreation = () => {
   ...
   const [approvals10,setApprovals10] = useState("approvals10")
   const [approvals11,setApprovals11] = useState("approvals11")
   ...
   const [food10,setFood10] = useState("food10")
   const [food11,setFood11] = useState("food11")
   const [food12,setFood12] = useState("food12")
        ...
        .on('value', function(snapshot){
            if(snapshot.exists()){
              var role=snapshot.val().Role;
                ...
                setCb91(true)
                if(role.includes('food10'))
                setCb92(true)
                if(role.includes('food11'))
                setCb93(true)
                if(role.includes('food12'))
                setCb94(true)
                ...
                setCb40(true)
                if(role.includes('approvals10'))
                setCb41(true)
                if(role.includes('approvals11'))
                setCb81(true)
