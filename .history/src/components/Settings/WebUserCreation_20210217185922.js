...
const WebUserCreation = () => {
   ...
   const [foodcatering,setFoodcatering] = useState("food@catering")
   const [cateringMenu,setCateringMenu] = useState("cateringMenu")
   ...
   const [reportsZ,setReportsZ] = useState("reportsZ")
   ...
   const [cb131,setCb131] = useState(false)
   const [cb132,setCb132] = useState(false)
   const [cb133,setCb133] = useState(false)
            ...
            if(snapshot.exists()){
              var role=snapshot.val().Role;
               ...
               if(role.includes('reports2'))
                  ...
                  setCb129(true)
                  if(role.includes('reportsZ'))
                  setCb131(true)
                  if(role.includes('food@catering'))
                  setCb132(true)
                  if(role.includes('cateringMenu'))
                  setCb133(true)
            }
        })
...
const onChangeCB131=(event)=>{
   setCb131(event.target.checked)
   setReportsZ(event.target.value)
}
const onChangeCB132=(event)=>{
   setCb132(event.target.checked)
   setFoodcatering(event.target.value)
}
const onChangeCB133=(event)=>{
   setCb133(event.target.checked)
   setCateringMenu(event.target.value)
}
   ...
   setHide(false)
    ...
    return (
      <Fragment>
        ...
        <Input type="checkbox" id="cb61" value={foodcatering} checked={cb132} onChange={onChangeCB132}/>&nbsp;&nbsp;Add Catering Packages<br/>
        <Input type="checkbox" id="cb61" value={cateringMenu} checked={cb133} onChange={onChangeCB133}/>&nbsp;&nbsp;Add Menu Items<br/>
        ...
        <CardBody>
        <Input type="checkbox"   value={reportsZ} checked={cb131} onChange={onChangeCB131}/>&nbsp;&nbsp;Single User Report<br/>
