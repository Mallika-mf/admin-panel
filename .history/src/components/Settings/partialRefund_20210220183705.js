                ...
                function (error, committed, snapshot) {
                    ...
                    if(select === "Dr"){
                        if(orderNo!==""&& dispatchDate!==""){
                            ...
                            alert("please provide dispatch date and order number ")
                        }
