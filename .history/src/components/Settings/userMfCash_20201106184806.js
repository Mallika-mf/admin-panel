...
const onSubmit=(event)=>{
    ...
    if (person === password) {
        ...
        var firebaseref1=app.database().ref().child("Users").child(cID).child("Wallet");
        ...
        firebaseref1.transaction(function(currentstock) {
           ...
           return currentstock;
             ...
             function(error, committed, snapshot) {
                a=snapshot.val();
                console.log(a);
                var ref=app.database().ref().child("Users").child(cID).child("Transactions").push();
            ...
            <Container fluid={true}>
                <Row>
                    <Col sm="12">
                     ...
                     <Input type="text" className="form-control" id="sname" value={sname} onChange={onChangeIdHandler}  autoComplete={cNO} placeholder="Chef ID"/>
                        ...
                        <span id="search" onClick={onChangeSearchHandler}><img src="https://img.icons8.com/ios-filled/24/000000/search.png" alt="search engine"/></span>
                         ...
                         <div className="clearfix"></div>{cID}
                         </div>
                        </Row>
                        <Row className="form-group row">
