...
const onSubmit=(event)=>{
    ...
    if (person === "5889") {
        ...
        var firebaseref1=app.database().ref().child("Users").child(window.uid).child("WalletInsta");
        ...
        firebaseref1.transaction(function(currentstock) {
           ...
           return currentstock;
             ...
             function(error, committed, snapshot) {
                a=snapshot.val();
                console.log(a);
                var ref=app.database().ref().child("Users").child(window.uid).child("TransactionInsta").push();
                ...
                if(select==="Cr")
                    alert("My Cash Added Succesfully!!!");
                else
                    alert("My Cash Deducted Succesfully!!!");
       ...
       return (
        <Fragment>
            <BreadCrumb parent={<Home/>} subparent="Settings" title=" My Cash"/>
