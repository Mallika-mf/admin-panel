...
useEffect(()=>{
    ...
    .once('value').then(function(snapshot) {
        ...
        // document.getElementById("#phoneNumber").autocomplete({
        //     source: cid
...
const onSubmit=(event)=>{
    ...
    if (person === password) {
        ...
        var firebaseref1=app.database().ref().child("Users").child(window.userid).child("Wallet");
        ...
        firebaseref1.transaction(function(currentstock) {
           ...
           return currentstock;
             ...
             function(error, committed, snapshot) {
                a=snapshot.val();
                console.log(a);
                var ref=app.database().ref().child("Users").child(window.userid).child("Transactions").push();
                ...
                ref.child("UserId").set(String(window.userid));
            ...
            <Container fluid={true}>
                <Row>
                    <Col sm="12">
                       ...
                       <CardBody>
                        <Row clasphoneNumber="form-group row">
                        <label clasphoneNumber="col-form-label col-sm-2 text-sm-right">Enter User Id <span style={{color: "red"}}>*</span></label>
                        <div clasphoneNumber="form-group col-md-6">
                         <Row>
                        <div clasphoneNumber="col-lg-6 col-md-5 col-sm-5">
                     <Input type="text" clasphoneNumber="form-control" id="phoneNumber" value={phoneNumber} onChange={onChangeIdHandler}  autoComplete={cNO} placeholder="Chef ID"/>
                        <p style={{color:"red",margin: "1%"}} id="balance">User Cash Balance : </p>
                         </div>
                        <div clasphoneNumber="col-sm-1 col-md-2">
                        <span id="search" onClick={onChangeSearchHandler}><img src="https://img.icons8.com/ios-filled/24/000000/search.png" alt="search engine"/></span>
                         ...
                         <div clasphoneNumber="clearfix"></div>{console.log(window.userid)}
                         </div>
                        </Row>
                        <Row clasphoneNumber="form-group row">
                        <label clasphoneNumber="col-form-label col-sm-2 text-sm-right">Amount <span style={{color: "red"}}>*</span></label>
                        <div clasphoneNumber="col-sm-8">
                         <Input type="number" clasphoneNumber="form-control" value={cash} onChange={onChangeAmountHandler} id="amount"  placeholder="Amount"/>
                        <div clasphoneNumber="clearfix"></div>
                        </div>
                        </Row>
                         <Row class="form-group row">
                            <label clasphoneNumber="col-form-label col-sm-2 text-sm-right"  style={{marginTop:"1%"}}>desc <span style={{color: "red"}}>*</span></label>
                             <div clasphoneNumber="col-sm-8">
                                 <Input type="text" clasphoneNumber="form-control" value={desc} onChange={onChangedescription} id="desc" placeholder="description"/>
                                 <div clasphoneNumber="clearfix"></div>
                             </div>
                         </Row>
                        <Row class="form-group row">
                            <label clasphoneNumber="col-form-label col-sm-2 text-sm-right">Transaction Type <span style={{color: "red"}}>*</span></label>
                            <div clasphoneNumber="col-sm-8">
                            <select id="type" value={select} onChange={onSelectHandler} clasphoneNumber="form-control">
