                                                                ...
                                                                !showOtpForm ?
                                                                    <form onSubmit={this.handleoginSubmit}>
                                                                        ...
                                                                        <div className="form-group text-center m-bottom-20">
                                                                            <button className="btn btn-secondary" style={{ background: "rgb(228, 28, 57)", color: "white", border: "1px solid rgb(228, 28, 57)", margin: "auto", marginTop: '15px', outline: '0' }} type="submit">
                                                                                {loginLoader? 
                                                                    ...
                                                                    <form onSubmit={this.onSubmitOtp}>
                                                                        ...
                                                                        <div className="form-group text-center m-bottom-20">
                                                                            <button className="btn btn-lg btn-outline-primary btn-block btn-login text-uppercase font-weight-bold mb-2" style={{ background: "rgb(228, 28, 57)", color: "white", border: "rgb(228, 28, 57)", margin: "auto", outline: '0' }} type="submit">
                                                                            {otpLoader? 
                                                                                <div style={{marginTop: '7px'}}>
                                                                                    <Loader
                                                                                    type="Circles"
