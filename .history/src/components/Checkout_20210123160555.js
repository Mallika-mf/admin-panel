					...
					<Row>
						...
						<Col md={4}>
                    		...
                    		<OverlayTrigger
									...
									<p className="mb-1 text-success" style={{ textAlign: "justify" }}>Taxes &amp; Charges  <span className="float-right text-success">₹ {taxes ? parseFloat(taxes).toFixed(2) : 0.00}</span></p>
