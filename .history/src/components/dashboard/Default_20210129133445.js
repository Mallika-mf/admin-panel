                    ...
                    <div className="hospital-widgets media">
                      ...
                      <div className="media-body">
                        <div className="hospital-content">
                          <div className="row">
                          <div className="col-6">
                          <h6 className="d-inline-block f-w-600" >{status2||" 0"}</h6>{/*<span className="badge flat-badge-primary m-l-10">OPD</span> */}
                    ...
                    <div className="hospital-widgets media">
                      ...
                      <div className="media-body">
                        <div className="hospital-content">
                          <div className="row">
                          <div className="col-6">
                          <h6 className="d-inline-block f-w-600" >{status4||" 0"}</h6>{/*<span className="badge flat-badge-primary m-l-10">OPD</span> */}
                    ...
                    <div className="hospital-widgets media">
                      ...
                      <div className="media-body">
                        <div className="hospital-content">
                          <div className="row">
                          <div className="col-6">
                          <h6 className="d-inline-block f-w-600" >{status6||" 0"}</h6>{/*<span className="badge flat-badge-primary m-l-10">OPD</span> */}
