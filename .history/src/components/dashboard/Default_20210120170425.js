                ...
                <Card className="o-hidden">
                  <CardBody>
                    <div className="hospital-widgets media">
                      ...
                      <div className="media-body">
                        <div className="hospital-content">
                        <h5 className="d-inline-block f-w-300">{user13||"Ac - 0 In - 0"}</h5>{/*<span className="badge flat-badge-primary m-l-10">OPD</span> */}
                          <p className="m-t-5 mb-0 f-w-300">Total Home Chef</p>{console.log(user13)}
                           <h5 className="d-inline-block f-w-300">{user12 ||"Ac - 0 In - 0"}</h5>{/*<span className="badge flat-badge-primary m-l-10">OPD</span> */}
                          <p className="m-t-5 mb-0 f-w-300">Total Local Chef</p>{console.log(user13)}
                        </div>
                        <div className="flowers">
                          <div className="flower1 flower-primary"></div>
                          <div className="flower2 flower-primary"></div>
