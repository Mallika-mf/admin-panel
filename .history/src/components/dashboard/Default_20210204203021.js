...
import {  ShoppingBag, User,UserPlus, Pocket, Monitor, Truck,BarChart,CheckCircle,Check,CheckSquare,Percent} from 'react-feather';
...
const Hospital = (props) => {
    ...
    useEffect(()=>{
      ...
      app.database().ref().child("Orders").orderByChild("Status").equalTo("1")
      .once('value',function(snapshot){
        setStatus1(snapshot.numChildren())
      })
      app.database().ref().child("Orders").orderByChild("Status").equalTo("2")
      .on('value',function(snapshot){
        setStatus2(snapshot.numChildren())
      })
      app.database().ref().child("Orders").orderByChild("Status").equalTo("3")
      .on('value',function(snapshot){
        setStatus3(snapshot.numChildren())
      })
      app.database().ref().child("Orders").orderByChild("Status").equalTo("4")
      .on('value',function(snapshot){
        setStatus4(snapshot.numChildren())
      })
      app.database().ref().child("Orders").orderByChild("Status").equalTo("5")
      .on('value',function(snapshot){
        setStatus5(snapshot.numChildren())
      })
      app.database().ref().child("Orders").orderByChild("Status").equalTo("10")
      .on('value',function(snapshot){
        setStatus6(snapshot.numChildren())
      })
      app.database().ref().child("Orders").orderByChild("Status").equalTo("100")
      .on('value',function(snapshot){
        setStatus7(snapshot.numChildren())
      })
      ...
      .once("value", function(snapshot) {
           ...
           app.database().ref().child("CloudKitchen")
                      ...
                      .once("value", function(snapshot1) {
                        snapshot1.forEach(snap1=>{
                          if(snap1.val().Local==="Yes"){
                            linactive.push(snap1.val())  
                          }
                        })
                            // console.log(lactive.length)
                            // console.log(linactive.length)

                          setUser12("Ac - "+lactive.length +" In - "+linactive.length)
              ...
              .once("value", function(snapshot) {
                      snapshot.forEach(snap=>{
                        if(snap.val().Local==="No"||snap.val().Local===undefined){
                          hactive.push(snap.numChildren());   
                        }
                      })
                   ...
                   app.database().ref().child("CloudKitchen")
                      ...
                      .once("value", function(snapshot1) {
                        snapshot1.forEach(snap1=>{
                          if(snap1.val().Local==="No"||snap1.val().Local===undefined){
                            
                            hinactive.push(snap1.val());   
                          }
                        })
                        console.log(hactive.length)

                        console.log(hinactive.length)
                          setUser13("Ac - "+hactive.length +" In - "+hinactive.length)
                          // setUser12("Ac - "+lactive )
      ...
      <Fragment>
        ...
        <Container fluid={true}>
            <Row>
                    ...
                    <div className="hospital-widgets media">
                      ...
                      <div className="media-body">
                        <div className="hospital-content">
                          <div className="row">
                          <div className="col-6">
                          <h6 className="d-inline-block f-w-600" >{user13||"Ac - 0 In - 0"}</h6>{/*<span className="badge flat-badge-primary m-l-10">OPD</span> */}
                          <p className="m-t-5 mb-0 f-w-600">Total Home Chef</p>
                          </div>
                          <div className="col-6">
                          <h6 className="d-inline-block f-w-700">{user12 ||"Ac - 0 In - 0"}</h6>{/*<span className="badge flat-badge-primary m-l-10">OPD</span> */}
                          <p className="m-t-5 mb-0 f-w-600">Total Local Chef</p>
                          </div>
                          </div> 
                        </div>
                        <div className="flowers">
              ...
              <NavLink to={(`${process.env.PUBLIC_URL}/table/basic`)} style={{color:"black"}}>
              <Col xl="3" className="xl-50 col-6 hospital-patients box-col-6">
                <Card className="o-hidden">
                  <CardBody>
                    <div className="hospital-widgets media">
                      <div className="hospital-box light-bg-danger"><CheckCircle/></div>
                      <div className="media-body">
                        <div className="hospital-content">
                           <h5 className="d-inline-block f-w-600">{status1 ||"0"}</h5>{/*<span className="badge flat-badge-secondary m-l-10">New</span> */}
                        <p className="m-t-5 mb-0 f-w-600">New Order</p>
                        </div>
                        <div className="flowers">
                          <div className="flower1"></div>
                          <div className="flower2"></div>
              ...
              <NavLink to={(`${process.env.PUBLIC_URL}/table/processing-order`)} style={{color:"black"}}>
              <Col xl="3" className="xl-50 col-6 hospital-patients box-col-6">
                <Card className="o-hidden">
                  <CardBody>
                    <div className="hospital-widgets media">
                      <div className="hospital-box light-bg-primary"><Check/></div>
                      <div className="media-body">
                        <div className="hospital-content">
                          <h5 className="d-inline-block f-w-600" >{status2||" 0"}</h5>{/*<span className="badge flat-badge-primary m-l-10">OPD</span> */}
                          <p className="m-t-5 mb-0 f-w-600">Process Order</p>
                        </div>
                        <div className="flowers">
                          <div className="flower1 flower-primary"></div>
                          <div className="flower2 flower-primary"></div>
              ...
              <Col xl="3" className="xl-50 col-6 hospital-patients box-col-6">
              <NavLink to={(`${process.env.PUBLIC_URL}/table/waititng-for-pickup`)} style={{color:"black"}}>
                <Card className="o-hidden">
                  <CardBody>
                    <div className="hospital-widgets media">
                      <div className="hospital-box light-bg-danger"><CheckSquare/></div>
                      <div className="media-body">
                        <div className="hospital-content">
                           <h5 className="d-inline-block f-w-600">{status3 ||"0"}</h5>{/*<span className="badge flat-badge-secondary m-l-10">New</span> */}
                        <p className="m-t-5 mb-0 f-w-600">Waiting For Pickup Orders</p>
                        </div>
                        <div className="flowers">
                          <div className="flower1"></div>
                          <div className="flower2"></div>
              ...
              <NavLink to={(`${process.env.PUBLIC_URL}/table/pickup-order`)} style={{color:"black"}}>
              <Col xl="3" className="xl-50 col-6 hospital-patients box-col-6">
                <Card className="o-hidden">
                  <CardBody>
                    <div className="hospital-widgets media">
                      <div className="hospital-box light-bg-primary"><CheckCircle/></div>
                      <div className="media-body">
                        <div className="hospital-content">
                          <h5 className="d-inline-block f-w-600" >{status4||" 0"}</h5>{/*<span className="badge flat-badge-primary m-l-10">OPD</span> */}
                          <p className="m-t-5 mb-0 f-w-600">Pickedup Orders</p>
                        </div>
                        <div className="flowers">
                          <div className="flower1 flower-primary"></div>
                          <div className="flower2 flower-primary"></div>
              ...
              <NavLink to={(`${process.env.PUBLIC_URL}/table/delivered-order`)} style={{color:"black"}}>
              <Col xl="3" className="xl-50 col-6 hospital-patients box-col-6">
                <Card className="o-hidden">
                  <CardBody>
                    <div className="hospital-widgets media">
                      <div className="hospital-box light-bg-danger"><Check/></div>
                      <div className="media-body">
                        <div className="hospital-content">
                           <h5 className="d-inline-block f-w-600">{status5 ||"0"}</h5>{/*<span className="badge flat-badge-secondary m-l-10">New</span> */}
                        <p className="m-t-5 mb-0 f-w-600">Delivered Orders</p>
                        </div>
                        <div className="flowers">
                          <div className="flower1"></div>
                          <div className="flower2"></div>
              ...
              <NavLink to={(`${process.env.PUBLIC_URL}/table/cancelled-order`)} style={{color:"black"}}>
              <Col xl="3" className="xl-50 col-6 hospital-patients box-col-6">
                <Card className="o-hidden">
                  <CardBody>
                    <div className="hospital-widgets media">
                      <div className="hospital-box light-bg-primary"><CheckSquare/></div>
                      <div className="media-body">
                        <div className="hospital-content">
                          <h5 className="d-inline-block f-w-600" >{status6||" 0"}</h5>{/*<span className="badge flat-badge-primary m-l-10">OPD</span> */}
                          <p className="m-t-5 mb-0 f-w-600">Cancelled Order</p>
                        </div>
                        <div className="flowers">
                          <div className="flower1 flower-primary"></div>
                          <div className="flower2 flower-primary"></div>
              ...
              <NavLink to={(`${process.env.PUBLIC_URL}/table/refunded-order`)} style={{color:"black"}}>
              <Col xl="3" className="xl-50 col-6 hospital-patients box-col-6">
                <Card className="o-hidden">
                  <CardBody>
                    <div className="hospital-widgets media">
                      ...
                      <div className="media-body">
                        <div className="hospital-content">
                           <h5 className="d-inline-block f-w-600">{status7 ||"0"}</h5>{/*<span className="badge flat-badge-secondary m-l-10">New</span> */}
                        <p className="m-t-5 mb-0 f-w-600">Refund Orders</p>
                        </div>
                        <div className="flowers">
                          <div className="flower1"></div>
                          <div className="flower2"></div>
