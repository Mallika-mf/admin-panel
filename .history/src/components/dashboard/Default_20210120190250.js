                ...
                console.log(snapshot.numChildren())
                      snapshot.forEach(snap=>{
                        if(snap.val().AStatus==="Active"){
                          if(snap.hasChild("Local")){
                            if(snap.val().Local==="Yes"){
                              console.log(snap.val())
                              hactive1=snap.numChildren();  
                              console.log(hactive1)
 
                            }else{
                              hactive2=snap.numChildren();   
  
                            }
                          }else{
                            hactive3=snap.numChildren()
                          }
                        }else{
                          if(snap.val().Local!==undefined){
                            if(snap.val().Local==="Yes"){
                              hinactive1=snap.numChildren();  
                              console.log(hinactive1)
 
                            }else{
                              hinactive2=snap.numChildren();   
  
                            }
                          }else if(snap.val().Local===undefined){
                            console.log(snap.val())
                            hinactive3=snap.numChildren()
                          }
                        }
                       
                      })
                    console.log(hinactive2+hinactive3)
                    console.log(hinactive2)
                    console.log(hinactive3)

                    console.log(hinactive1+hinactive2+hinactive3)
                    setUser12("Ac - "+hactive1 + "In - "+hinactive1)
                    setUser13("Ac - "+(hactive2+hactive3) + "In - "+(hinactive2+hinactive3))
