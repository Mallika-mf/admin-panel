      ...
      .once("value", function(snapshot) {
           ...
           app.database().ref().child("CloudKitchen")
              ...
              .once("value", function(snapshot) {
                      ...
                      //   }
                      // })
                      if(snapshot.val().Local==="No"||snapshot.val().Local===undefined){
                            hactive=snapshot.numChildren();   
                          }
                   app.database().ref().child("CloudKitchen")
                      .orderByChild("AStatus").equalTo("InActive")
                      .once("value", function(snapshot1) {
                        ...
                        //   }
                        // })
                        if(snapshot1.val().Local==="No"|| snapshot1.val().Local===undefined){
                          console.log(snapshot1.numChildren())
                          hinactive = snapshot1.numChildren()
                        }
