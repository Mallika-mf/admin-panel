                                    ...
                                    {users.filter(orders =>
                                            orders.Chef.includes(search)).map((item,id)=>{                                                  
                                                    return(
                                                        ...
                                                        <td className="status"><select  className="form-control" value={status} onChange={onChangeStatus} id="items">
                                                           <option value="Select">{"Select"}</option>
                                                ...
                                                <td className="reason"><input className="reason" type="text" value={reason} onChange={onChangeReason}/></td> :
                                                ...
                                                <td className="paymentid"><input className="paymentid" type="text" value={item.PaymentMode} onChange={onChangePaymentMode}/></td>
                                                           ...
                                                           <td className="" style={{ fontSize: "25px", fontWeight: "bold"}}><button type="button" id="savebtn" className="btn btn-success btn-md">{"Save"}</button></td>
