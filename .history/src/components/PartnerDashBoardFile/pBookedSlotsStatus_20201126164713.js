...
const PBookedSlotsStatus = (props) => {
  ...
  const onChangePaymentMode = (event) => {
    ...
    console.log('PaymentMode',event.target.id)
  ...
  const onChangePaymentStatus = (event) => {
    ...
    console.log('PaymentStatus',event.target.id)
  ...
  const onChangeReason = (event) => {
    ...
    console.log('Reason',event.target.id)
    users.map(item => {
      if (event.target.id === item.PushId) {
                          ...
                          <tr key={id}>
...

                            {
                              item.Status == "" || item.Status == null || item.Status === undefined ?
                                <td className="status"><select className="form-control" id={item.PushId} value={status} onChange={onChangeStatus} id="items">
                                  <option value="Select">{"Select"}</option>
                                  <option value="Paid">{"Paid"}</option>
                                  <option value="Hold">{"Hold"}</option>
                                  <option value="Not Intrested">{"Not Intrested"}</option></select>
                                </td> : item.Status == "Paid" ?
                                  <td className="status"><select className="form-control" id={item.PushId} value={item.Status} onChange={onChangeStatus} id="items">
                                    <option value="Paid">{"Paid"}</option>
                                    <option value="Hold">{"Hold"}</option>
                                    <option value="Not Intrested">{"Not Intrested"}</option></select>
                                  </td> : item.Status == "Hold" ?
...

                            {
                              item.Reason == "" || item.Reason == null || item.Reason == undefined ?
                                <td className="reason"><input className="reason" type="text" id={item.PushId} value={reason} onChange={onChangeReason} /></td> :
                                <td className="reason"><input className="reason" type="text" id={item.PushId} value={item.Reason} onChange={onChangeReason} /></td>

                            }
                            {
                              item.PaymentStatus == "" || item.PaymentStatus == null || item.PaymentStatus == undefined ?
                                <td className="item_route"><select className="form-control payment" id={item.PushId} value={paymentstatus} onChange={onChangePaymentStatus} id="items">
                                  <option value="Select">Select</option>
                                  <option value="Paid">Paid</option>
                                  <option value="UnPaid">Not Paid</option></select>
                                </td> : item.PaymentStatus == "Paid" ?
                                  <td className="item_route"><select className="form-control payment" id={item.PushId} value={item.PaymentStatus} onChange={onChangePaymentStatus} id="items">
                                    <option value="Paid">Paid</option>
                                    <option value="UnPaid">Not Paid</option></select>
                                  </td> :
                                  <td className="item_route"><select className="form-control payment" id={item.PushId} value={item.PaymentStatus} onChange={onChangePaymentStatus} id="items">
                            ...
                            }
                            {
                              item.PaymentMode == "" || item.PaymentMode == null || item.PaymentMode == undefined ?
                                <td className="paymentid"><input className="paymentid" type="text" id={item.PushId} value={paymentmode} onChange={onChangePaymentMode} /></td> :
                                <td className="paymentid"><input className="paymentid" type="text" id={item.PushId} value={item.PaymentMode} onChange={onChangePaymentMode} /></td>
                            }
