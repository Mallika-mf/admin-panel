                          ...
                          <tr key={id}>
...

                            {
                              item.Status == "" || item.Status == null || item.Status === undefined ?
                                <td className="status"><select className="form-control" id={item.PushId} value={status} onChange={onChangeStatus} >
                                  <option value="Select">{"Select"}</option>
                                  <option value="Paid">{"Paid"}</option>
                                  <option value="Hold">{"Hold"}</option>
                                  <option value="Not Intrested">{"Not Intrested"}</option></select>
                                </td> : item.Status == "Paid" ?
                                  <td className="status"><select className="form-control" id={item.PushId} value={item.Status} onChange={onChangeStatus} >
                                    <option value="Paid">{"Paid"}</option>
                                    <option value="Hold">{"Hold"}</option>
                                    <option value="Not Intrested">{"Not Intrested"}</option></select>
                                  </td> : item.Status == "Hold" ?
                            ...
                            }
                            {
                              item.PaymentStatus == "" || item.PaymentStatus == null || item.PaymentStatus == undefined ?
                                <td className="item_route"><select className="form-control payment" id={item.PushId} value={paymentstatus} onChange={onChangePaymentStatus} >
                                  <option value="Select">Select</option>
                                  <option value="Paid">Paid</option>
                                  <option value="UnPaid">Not Paid</option></select>
                                </td> : item.PaymentStatus == "Paid" ?
                                  <td className="item_route"><select className="form-control payment" id={item.PushId} value={item.PaymentStatus} onChange={onChangePaymentStatus} >
                                    <option value="Paid">Paid</option>
                                    <option value="UnPaid">Not Paid</option></select>
                                  </td> :
                                  <td className="item_route"><select className="form-control payment" id={item.PushId} value={item.PaymentStatus} onChange={onChangePaymentStatus} >
