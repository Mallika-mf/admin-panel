...
database.ref().child("SlotsReport")
            .orderByChild("Date").equalTo(state.sdate)
      .once('value', function(snapshot){
          if(snapshot.exists()){
         ...
         database = app.database();
database.ref().child("SlotsReport")
            .orderByChild("Date").equalTo(state.edate)
      .once('value', function(snapshot){
          if(snapshot.exists()){
                                                ...
                                                if(item.Status===""||item.Status===null){
                                                    ...
                                                    return(
                                                       ...
                                                       <td className="status"><select  className="form-control" id="items">
                                                           ...
                                                           <td className="" style={{textAlign:"center", fontSize: "25px", fontWeight: "bold"}}><button type="button" id="savebtn" className="btn btn-success btn-md">{"Save"}</button></td>
