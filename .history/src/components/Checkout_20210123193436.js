		...
		if (localFood === "Yes") {
			return (
				...
				<div className="d-flex mb-4 osahan-cart-item-profile">
					...
					<div className="d-flex flex-column">
						<h6 className="mb-1 text-white">{kitchenName}
						</h6>
			...
			return (
				...
				<div className="d-flex mb-4 osahan-cart-item-profile">
					<Image fluid className="mr-3 rounded-pill" alt="osahan" src={image} />
					<div className="d-flex flex-column">
						<h6 className="mb-1 text-white">{chefName}
						</h6>
						{/* <p className="mb-0 text-white"><Icofont icon="location-pin" /> 2036 2ND AVE, NEW YORK, NY 10029</p> */}
					</div>
				</div>
								...
								<div className="bg-white rounded shadow-sm p-4 mb-4">
									...
									<Row>
										{get(userAddresses, 'length', 0) > 0 ?
										 ...
										 <button onClick={this.handleAddressSelectionSubmit} className="btn btn-sm btn-primary mr-2" style={{ background: "#FFFFFF", color: "white", border: "solid 2px #E41C39", marginRight: "0%", marginTop: "5%", fontWeight: 'bold',height:"30px",float:"right", marginLeft:"30%" ,marginTop:"30%"}} >Add New Address</button>
                                                {addressError ?
                                                    <div className="form-group" style={{ paddingTop: "85px" }}>
									...
									{this.state.showPromocode === true ?
										<>
											<InputGroup className="input-group-sm mb-2">
												...
												<InputGroup.Append>
													<Button variant="primary" type="button" onClick={this.handlePromo} id="button-addon2" disbaled={this.state.promocode.length === 0}><Icofont icon="sale-discount" /> APPLY</Button>
												</InputGroup.Append>
											</InputGroup>
										</> :
