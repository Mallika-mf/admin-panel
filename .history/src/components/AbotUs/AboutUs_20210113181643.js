        ...
        <div>
            ...
            <div className = "choose">
                <div className = " col-lg-24 content">
                    ...
                    <p style={{wordSpacing:"-1.5px"}}> MothersFood is a homemade food delivery app. Delivering numerous cuisines and dishes made by home chefs in their hygienic kitchens.</p>
                </div>
                {/* <div className = "btn">
