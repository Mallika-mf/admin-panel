                                    ...
                                    <div class="icon-box-fourteen text-center">
                                        <div class="row">
                                            ...
                                            <div class="col-lg-8 col-md-8 col-sm-12">
                                                ...
                                                <a href="/partnerwithus#registerwithus" className="btn btn-info btn-icon icon-right btn-find-food">For a Partner</a>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                    ...
                                    <div class="icon-box-fourteen text-center">
                                        <div class="row">
                                            ...
                                            <div class="col-lg-8 col-md-8 col-sm-12">
                                                ...
                                                <p class="m-top-0 p-top-0 block-info-text">Reach more customers 
                                                and more growth with us</p>
                                                <a href="/ridewithus"  className="btn btn-info btn-icon icon-right  btn-danger" style={{ borderRadius: "50px",color:"#B4031B" }}>For Delivery</a>
                                            </div>
                                        </div>
                                    </div>
                                </div>
