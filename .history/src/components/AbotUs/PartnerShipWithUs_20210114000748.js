                                    ...
                                    <div class="icon-box-fourteen text-center">
                                        <div class="row">
                                            ...
                                            <div class="col-lg-8 col-md-8 col-sm-12">
                                                ...
                                                <a href="/partnerwithus#registerwithus" className="btn btn-info btn-icon icon-right btn-find-food btn-danger" style={{ borderRadius: "50px",width:"500px"}}>For a Partner</a>
                                            </div>
                                        </div>
                                    </div>
                                </div>
