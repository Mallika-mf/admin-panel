...
function Partnership() {
    return (
        <section class="become-member-area m-top-50 p-top-50 p-bottom-50">
            <div class="icon-boxes">
                <div class="container">
                    <div class="row">
                        <div class="col-12 section-title text-center m-bottom-20">
                            <h5><b>Be a part of Mothers Food</b></h5>
                            <h2 class="theme-title"><b>Become a member!</b></h2>
                        </div>
                                    ...
                                    <div class="icon-box-fourteen text-center">
                                        <div class="row">
                                            ...
                                            <div class="col-lg-8 col-md-8 col-sm-12">
                                                ...
                                                <a href="/partnerwithus#registerwithus" class="btn btn-info btn-icon icon-right btn-find-food">For a Partner</a>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div class="card">
                                <div class="card-body text-center">
                                    <div class="icon-box-fourteen text-center">
                                        <div class="row">
                                            <div class="col-lg-4 col-md-4 col-sm-12">
                                                <img src="assets/img/xd/delivery@2x.png" height="100px" class="img-responsive" alt="mothersfood" />
                                            </div>
                                            <div class="col-lg-8 col-md-8 col-sm-12">
                                                <h6 class="color-dark m-top-5 m-bottom-0 p-bottom-0 block-title">Become a Delivery Partner</h6>
                                                <p class="m-top-0 p-top-0 block-info-text">Reach more customers 
                                                and more growth with us</p>
                                                <a href="/ridewithus" class="btn btn-info btn-icon icon-right btn-find-food">For Delivery</a>
                                            </div>
                                        </div>
                                    </div>
                                </div>
