...
class Login extends React.Component {
	...
	render() {
		const {  showOtpForm, loginLoader, otpLoader} = this.state;
											...
											<div className="card-body">
												{
													!showOtpForm ?
														<form onSubmit={this.handleoginSubmit}>
															...
															<div className="form-label-group">
																<Form.Control type="number" name="mobile"  id="inputEmail" onChange={this.handleInputChange} placeholder="Email address" required />
														...
														<form onSubmit={this.onSubmitOtp}>
															<div className="form-label-group">
																<Form.Control type="password" name="otp" id="inputOtp" placeholder="OTP (One Time Password)" onChange={this.handleInputChange} required />
																<Form.Label htmlFor="inputOtp"> OTP</Form.Label>
															</div>
															{/* <div className="form-group">
