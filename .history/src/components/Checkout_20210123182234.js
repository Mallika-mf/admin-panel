									...
									{this.state.showPromocode === true ?
										<>
											<InputGroup className="input-group-sm mb-2">
												...
												<InputGroup.Append>
													<Button variant="primary" type="button"  onClick={this.handlePromo} id="button-addon2"><Icofont icon="sale-discount" disbaled/> APPLY{console.log(this.state.promocode.length)}{console.log(this.state.promocodeFail)}</Button>
												</InputGroup.Append>
											</InputGroup>
										</> :
