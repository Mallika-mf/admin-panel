                                        ...
                                        {searchValue.map((item, id) => {
                                            ...
                                            return (
                                                <tr key={id}>
                                                    ...
                                                    <td className="actions-view" style={{ textAlign: "center" }}><button type="button" id={item.PickkupOrderId+"+"+item.Pushid} onClick={onClickPickkup} className="btn btn-primary btn-md">{"Reassign"}</button><br/><br/>
                                                    <Button type="button" onClick={onCancelPickkup}  className="warning">{"Cancel"}</Button></td>
