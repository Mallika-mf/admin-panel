...
import { Home, Trash, ChevronRight, ChevronLeft } from 'react-feather';
                    ...
                    {itemMenu.map((item,index)=>{
                        if(item!==""){
                            return(
                                ...
                                <div className="col-9" ><ChevronRight color="blue" id={item} onClick={onClickAddMenuItem} size={15}/><Trash color="red"onClick={() =>onDeleteMenu(index)} size={15}/></div>
                                </Row>
                                </Card>
                            )
                        }
        ...
        <Modal.Footer>
          ...
          <Button variant="primary" onClick={onAddMenu}>
            Save 
                    ...
                    <>
                    <Card>
                        <CardHeader><ChevronLeft onClick={onBackToCustomize}/>Add Item To {menuName}</CardHeader>
