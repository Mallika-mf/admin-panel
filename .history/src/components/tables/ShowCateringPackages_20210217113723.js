                    ...
                    {itemMenu.map((item,index)=>{
                        if(item!==""){
                            return(
                                ...
                                <div className="col-3" style={{textAlign:"left"}}><Button className="primary" id={item} onClick={onClickAddMenuItem} >Show Menu</Button>&nbsp;&nbsp;<Trash color="red"onClick={() =>onDeleteMenu(index)} /></div>
                                </Row>
                                </Card>
                            )
                        }
