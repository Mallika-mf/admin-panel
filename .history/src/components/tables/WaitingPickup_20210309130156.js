                                        ...
                                        {searchValue.map((item, id) => {
                                            ...
                                            return (
                                                <tr key={id}>
                                                    ...
                                                    <td className="actions-view" style={{ textAlign: "center" }}><button type="button" id={item.Pushid} onClick={onClickPickkup} className="btn btn-primary btn-md">{"Reassign"}</button></td>
