...
const AddFoodItems = () => {
  ...
  const onSubmitHandler = (event) => {
    ...
    // var addonRef = firebaseref.child("ADDONS")
    // for(let i2=0; i2<newAddonList.length; i2++){
    //   var objCells = newAddonList[i2];
    //   addonRef.set(objCells)
    // }
    ...
    for (var index = 0; index < newAddonList.length; index++) {
      ...
      // firebaseref.child("addons").child(getaddonspushid).child("Name").set(addoname)
      // firebaseref.child("addons").child(getaddonspushid).child("pushdi").set(addonspushid)
  ...
  const onUpdateHandler = (event) => {
    ...
    for (var index1 = 0; index1 < newFoodList.length; index1++) {
      console.log(newFoodList[index1])
      firebaseref.child("FOODTYPE").set(newFoodList[index1])
    }
