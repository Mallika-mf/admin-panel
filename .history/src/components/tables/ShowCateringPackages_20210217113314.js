                    ...
                    {itemMenu.map((item,index)=>{
                        if(item!==""){
                            return(
                                ...
                                <div className="col-3" style={{textAlign:"left"}}><Button className="Success" id={item} onClick={onClickAddMenuItem} >Show Menu</Button><Trash color="red"onClick={() =>onDeleteMenu(index)} /></div>
                                </Row>
                                </Card>
                            )
                        }
