                                            ...
                                            return (
                                                <tr key={id}>
                                                    ...
                                                    {item.DeliveryApiRemarks !== undefined && item.PickUpETA !== undefined && item.DropETA !== undefined && item.DunzoTrackingUrl !== undefined ?
                                                     ...
                                                     <td className="actions-view" style={{ textAlign: "center" }}><button type="button" id={item.Pushid} onClick={onClickChotabeta} className="btn btn-primary btn-md">{"Reassign"}</button>
