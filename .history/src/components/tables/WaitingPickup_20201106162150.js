...
const  onChangeHandler=(event)=>{
    ...
    const onChangeDeliveryApiRemarks = (event) =>{
                                ...
                                <Table id="datatable">
                                    ...
                                    { searchValue.filter(orders =>
                                        ...
                                        return(
                                                ...
                                                {item.DeliveryName!==undefined ?
                                                 <td><textarea type="text" id={item.Pushid}  className="crop" rows="1" cols="30"></textarea></td>:
                                                <td><textarea type="text" id={item.Pushid} value={item.DeliveryApiRemarks} onChange={onChangeDeliveryApiRemarks} className="crop" rows="1" cols="30"></textarea>{item.DeliveryApiRemarks}</td>
                                            }
