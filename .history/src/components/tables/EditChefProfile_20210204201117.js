...
const onClickCuisineDelete = (event) =>{
              ...
              {cuisineList.map((item, index) => {
                return (
                  <tr key={index}>
                    <td>{item.Name}</td>
                    {/* <td>{}</td> */}
                    <td><Trash id={item.PushId} onClick={ onClickCuisineDelete} size={15} /></td>
                  </tr>
                )
              })}
            </tbody>
            ...
            <tbody>
              {foodTypeList.map((item, index) => {
                return (
                  <tr key={index}>
                    <td>{item.Name}</td>
                    <td><Trash id={item.PushId} onClick={ onDeleteFoodType} size={15} /></td>
                  </tr>
                )
              })}
            </tbody>
