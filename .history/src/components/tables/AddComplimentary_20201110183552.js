...
const AddComplimentaryTable = () => {
    ...
    const onSubmitHandler=(event)=>{
        ...
        var firebaseref=app.database().ref().child("Masters").child("Complimentary").push();
    ...
    const onClickUpdateHandler=(event)=>{
        ...
        var firebaseref=app.database().ref().child("Masters").child("Complimentary").child(pushId);
        if(textName!==""){
    ...
    return (
        <Fragment>
            <BreadCrumb parent={<Home/>} subparent="Food Management" title=" Add Complimentary "/>
            <Container fluid={true}>
                <Row>
                    <Col sm="12">
                <CardHeader>
                                <h6>Add Complimentary </h6>
                                {/* <span> Use a class <code> table </code> to any table.</span> */}
                         </CardHeader>
                    </Col>
                    </Row>
                    <Row style={{margin:"1%"}}>
                    <label className="col-form-label col-md-2 text-md-right">Enter Complimentary Item Name</label>
                    <div className="col-sm-9">
                    <input type="text" className="form-control" id="name" onChange={onChangeHandler} placeholder="Complimentary Item Name"/>
                   ...
                   <Row >
                    <Col sm="12">
                        <Card>
                        <CardHeader>
                                <h6>Complimentary Items </h6>
                                {/* <span> Use a class <code> table </code> to any table.</span> */}
                            </CardHeader>
                            <div className="table-responsive">
                                <Table id="data-table" className="table table-striped table-bordered table-sm"  width="100%">
                                    <thead>
                                        <tr>
...
export default AddComplimentaryTable;