 ...
 const onChangeRemark= (event)=>{
     ...
     searchValue.map(item=>{
         if(event.target.id === item.Pushid){
             event.target.value = item.Remarks
         }
     })
 }
                                    ...
                                    { searchValue.filter(orders =>
                                        ...
                                        return(
                                                ...
                                                {item.DeliveryApiRemarks!==undefined && item.PickUpETA!==undefined && item.DropETA!==undefined && item.DunzoTrackingUrl !==undefined?
                                                 <td><p>{item.DeliveryApiRemarks}</p><p>{"PickUpEta"+item.PickUpETA}</p><p>{"DropEta:"+item.DropETA}</p><a href={"Traking URL:"+item.DunzoTrackingUrl} target = "_blank">{item.DunzoTrackingUrl}</a></td>: item.DeliveryApiRemarks!==undefined && item.PickUpETA===undefined && item.DropETA===undefined && item.DunzoTrackingUrl ===undefined?
                                                ...
                                                <td><a href={"Traking URL:"+item.DunzoTrackingUrl} target = "_blank">{item.DunzoTrackingUrl}</a></td>: item.DeliveryApiRemarks!==undefined && item.PickUpETA!==undefined && item.DropETA===undefined && item.DunzoTrackingUrl==undefined?
                                                ...
                                                <td><p>{item.DeliveryApiRemarks}</p><a href={"Traking URL:"+item.DunzoTrackingUrl} target = "_blank">{item.DunzoTrackingUrl}</a></td>: item.DeliveryApiRemarks===undefined && item.PickUpETA!==undefined && item.DropETA!==undefined && item.DunzoTrackingUrl==undefined?
                                                ...
                                                <td><p>{"DropEta:"+item.DropETA}</p><a href={"Traking URL:"+item.DunzoTrackingUrl} target = "_blank">{item.DunzoTrackingUrl}</a></td>: item.DeliveryApiRemarks===undefined && item.PickUpETA===undefined && item.DropETA!==undefined && item.DunzoTrackingUrl!==undefined?
                                                <td><p>{"DropEta:"+item.DropETA}</p><a href={"Traking URL:"+item.DunzoTrackingUrl} target = "_blank">{item.DunzoTrackingUrl}</a></td>: item.DeliveryApiRemarks!==undefined && item.PickUpETA!==undefined && item.DropETA!==undefined && item.DunzoTrackingUrl ===undefined?
                                                ...
                                                <td><p>{item.DeliveryApiRemarks}</p><p>{"PickUpEta"+item.PickUpETA}</p><a href={"Traking URL:"+item.DunzoTrackingUrl} target = "_blank">{item.DunzoTrackingUrl}</a></td> : item.DeliveryApiRemarks!==undefined && item.PickUpETA===undefined && item.DropETA!==undefined && item.DunzoTrackingUrl!==undefined?
                                                <td><p>{item.DeliveryApiRemarks}</p><p>{"DropEta:"+item.DropETA}</p><a href={"Traking URL:"+item.DunzoTrackingUrl} target = "_blank">{item.DunzoTrackingUrl}</a></td> : item.DeliveryApiRemarks===undefined && item.PickUpETA!==undefined && item.DropETA!==undefined && item.DunzoTrackingUrl!==undefined?
                                                <td><p>{"PickUpEta"+item.PickUpETA}</p><p>{"DropEta:"+item.DropETA}</p><a href={"Traking URL:"+item.DunzoTrackingUrl} target = "_blank">{item.DunzoTrackingUrl}</a></td>
                                                <td><p>{""}</p></td>:
                                            }
                                                ...
                                                <td><textarea type="text" id={item.Pushid} value={item.Remark} onChange={onChangeRemark} className="crop" rows="1" cols="30"></textarea></td>
