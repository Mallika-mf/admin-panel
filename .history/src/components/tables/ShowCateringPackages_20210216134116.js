                                ...
                                {/* <Row> */}
                                    <div className="list-card bg-white h-100 rounded overflow-hidden position-relative shadow-sm">
                                        <div className="list-card-image">
                                            ...
                                            <div
                                                className={`favourite-heart position-absolute ${item.Type === "Veg" ? "text-green" : item.Type === "NonVeg" ? "text-red" : "text-yellow"}` } style={{color:`${item.Type === "Veg" ? "text-green" : item.Type === "NonVeg" ? "text-red" : "text-yellow"}`}}
                                            >
                                        ...
                                        <div className="p-3 position-relative">
                                            <div className="list-card-body">
                                                ...
                                                {item.Description ? (
                                                    <p className="text-gary mb-3">{item.Description}</p>
                                                ) : (
                                                        ""
                                                    )}
                                                {item.Price ? (
