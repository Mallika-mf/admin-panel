 ...
 const AsyncMap = withScriptjs(
  withGoogleMap(
    ...
    >
     ...
     />
{/*Marker*/}
     <Marker google={state.google.google}
      name={'Dolores park'}
         draggable={true}
...
let map;
//  if( state.center.lat !== undefined ) {
  map = <div>
    <div>
     <div className="form-group">
      <label htmlFor="">City</label>
      <input type="text" name="city" className="form-control" onChange={ onChange } readOnly="readOnly" value={ state.city }/>
     </div>
     <div className="form-group">
      <label htmlFor="">Area</label>
      <input type="text" name="area" className="form-control" onChange={ onChange } readOnly="readOnly" value={ state.area }/>
     </div>
     <div className="form-group">
      <label htmlFor="">State</label>
      <input type="text" name="state" className="form-control" onChange={ onChange } readOnly="readOnly" value={state.state }/>
     </div>
     <div className="form-group">
      <label htmlFor="">Address</label>
      <input type="text" name="address" className="form-control" onChange={onChange } readOnly="readOnly" value={ state.address }/>
     </div>
    </div>
    <AsyncMap
  ...
  return (
    <Fragment>
      ...
      <Container fluid={true}>
        ...
        <Row className="form-row">{consol.log(state.center.lat)}
