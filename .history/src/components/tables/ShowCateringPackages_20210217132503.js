                                ...
                                {/* <Row> */}
                                    ...
                                    <div className="list-card bg-white h-100 rounded overflow-hidden position-relative shadow-sm">
                                        ...
                                        <div className="list-card-image">
                                            ...
                                            <div
                                                className={`favourite-heart position-absolute float-right ${item.Type === "Veg" ? "text-green" : item.Type === "NonVeg" ? "text-red" : "text-yellow"}` } style={{color:`${item.Type === "Veg" ? "green" : item.Type === "NonVeg" ? "red" : "yellow"}`}}
                                            >
