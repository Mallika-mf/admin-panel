   ...
   const onChangeworkingPartnerName=(event)=>{
    ...
    const onSearchHandler=(event)=>{
     ...
     return firebaseref.once('value').then(function(snapshot) {
         ...
         setMobileNumber( parseInt(snapshot.val().MobileNumber));
         ...
         setBranchAddress( snapshot.val().BranchAddress);
          ...
          // }
           database.ref().child("Masters").child("Localities")
           .orderByChild("City").equalTo(snapshot.val().City1)
      ...
      firebaseref1.child("Password").set(String(password));
               ...
               var firebaseref=app.database().ref().child("Franchise").child(searchName);
                  ...
                  //  firebaseref.child("Price").set(deliveryBaseKm);
                   firebaseref.child("MobileNumber").set(String(mobileNumber));
            ...
            <Container fluid={true}>
                {buttonHide===true?
                 ...
                 <Col sm="12">
                     ...
                     {/* <Button className="warning" onClick={onVerifyCodeSubmit} id="verify-code-button" href="#" style={{color: "white",fontFamily: 'Cinzel',fontWeight: "bold"}}>Verify</Button>	 */}
                     {/* </Col> */} 
                  ...
                  <div className="clearfix"></div>
                     ...
                     <select value={selectLocality} onChange={onChangeLocality} className="form-control" >
                     <option value="Select">Select</option>
                     ...
                     <Input type="number" value={commisionPercentage} onChange={onChangeCommisiionPercentage} className="form-control"  placeholder=""/>                      
                      <div className="clearfix"></div>
                     </Col>
                     <Col className="form-group col-md-3">
                     <label className="form-label">Password<span style={{color: "red"}}>*</span></label>
                     <Input type="password" value={password} onChange={onChangePassword} className="form-control"  placeholder=""/>                      
                      <div className="clearfix"></div>
                     </Col>
                     <Col className="form-group col-md-3">
                     <label className="form-label">Gst<span style={{color: "red"}}>*</span></label>
                     <Input type="password" value={gst} onChange={onChangeGstNumber} className="form-control"  placeholder=""/>                      
                      <div className="clearfix"></div>
                     </Col>
                     </Row>
                     {/* <Row>
                     ...
                     <Input onChange={onChangeAdharFile } type="file"  className="form-control" />
                     <div className="clearfix"></div>
                      </Col>
                     ...
                     <Col className="col-sm-10">
                     <Input onChange={ onChangePanFile} type="file" className="form-control" />
                     <div className="clearfix"></div>
                      </Col>
                      <div className="col-sm-2">
                     ...
                     <Col className="col-sm-10">
                     <Input onChange={onChangePassBookFile } type="file"className="form-control" />
                     <div className="clearfix"></div>
                      </Col>
                      <div className="col-sm-2">
                     ...
                     <Col className="col-sm-10">
                     <Input onChange={ onChangeGst} type="file"  className="form-control" />
                     <div className="clearfix"></div>
                      </Col>
                      <div className="col-sm-2">
