                    ...
                    {itemMenu.map((item,index)=>{
                        if(item!==""){
                            return(
                                ...
                                <div className="col-3" style={{textAlign:"left"}}><Button className="primary" id={item} onClick={onClickAddMenuItem} >Show Menu</Button>&nbsp;&nbsp;<Button className="secondary"onClick={() =>onDeleteMenu(index)} ></Button></div>
                                </Row>
                                </Card>
                            )
                        }
