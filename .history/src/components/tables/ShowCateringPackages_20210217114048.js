                    ...
                    {itemMenu.map((item,index)=>{
                        if(item!==""){
                            return(
                                ...
                                <div className="col-3" style={{textAlign:"left"}}><Button color="primary" size="sm" id={item} onClick={onClickAddMenuItem} >Show Menu</Button>&nbsp;&nbsp;<Button color="warning" size="sm"onClick={() =>onDeleteMenu(index)} ></Button></div>
                                </Row>
                                </Card>
                            )
                        }
