      ...
      {/* <Container fluid={true}>
          ...
          <Col className="form-group col-md-6">
            ...
            <Row>
              <Col className="col-lg-6 col-md-5 col-sm-5">
                <Input type="text" name="search" value={this.state.search} onChange={this.onChangeHandler} className="form-control" />
              </Col>
        ...
        <Row className="form-row">
          <Col className="form-group col-md-3">
            ...
            <input type="number" name="deliveryTime" value={this.state.deliveryTime} onChange={this.onChangeHandler} className="form-control"/>
            <div className="clearfix"></div>
          </Col>
        </Row>
        <Row className="form-row">
          <Col className="form-group col-md-3">
            ...
            <input type="number" name="costForTwo"  value={this.state.costForTwo} onChange={this.onChangeHandler} className="form-control"/>
            <div className="clearfix"></div>
          </Col>
        </Row>
        <Row className="form-row">
          <Col className="form-group col-md-3">
            ...
            <select name="cuisine" value={this.state.cuisine} onChange={this.onChangeCuisine} className="form-control">
              <option value="Select">Select</option>
              {this.state.cuisineName.map((item, id) => <option key={id} value={item.PushId}>{item.Name}</option>)}
            </select>
            <div className="clearfix"></div>
          </Col>
          {/* {showTable===true? */}
        ...
        <Row className="form-row">
          <Col className="form-group col-md-3">
            ...
            <select name="foodCategory" value={this.state.foodCategory} onChange={this.onChangeFoodCategory} className="form-control">
              <option value="Select">Select</option>
        ...
        <Row className="form-row">
          <Col className="form-group col-md-3">
            ...
            <Input name="openTime" type="time" value={this.state.openTime} onChange={this.onChangeHandler} className="form-control" />
            <div className="clearfix"></div>
          </Col>
          <Col className="form-group col-md-3">
            <label className="form-label">Close Time <span style={{ color: "red" }}>*</span></label>
            <Input type="time" name="closeTime" value={this.state.closeTime} onChange={this.onChangeHandler} className="form-control" />
            <div className="clearfix"></div>
          </Col>
        </Row>
        {/* <Row>
        ...
        {/* <Row className="form-row">{console.log(this.state.cuisineName)}
