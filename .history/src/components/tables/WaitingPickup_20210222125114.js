                    ...
                    <Col sm="12">
                        <Card>
                            ...
                            <Modal isOpen={uber} >
                                ...
                                <div className="form-group col-md-9">
                            <label className="form-label">Search </label>
                            <input type="number" value={driverName} required="" onChange={onChangeDriverName}  className="form-control" placeholder="Enter Number...." />
                            <div className="clearfix"></div>
                        </div>
                                <div className="form-group col-md-9">
                            <label className="form-label">Search </label>
                            ...
                            <div className="clearfix"></div>
                                ...
                                <ModalFooter>
                                <Button variant="secondary" onClick={onSubmitUber}>
                                        Submit
                            </Button>
