                                ...
                                <Table>
                                   ...
                                   {searchValue.map((item,id) => {
                                                ...
                                                return(
                                                    ...
                                                    <td className="item_pushid" style={{display:"none"}}><textarea type="text" value={item.PushId} onChange={onChangeTextHandler} className="name" rows="1" cols="30">{item.PushId}</textarea></td>
