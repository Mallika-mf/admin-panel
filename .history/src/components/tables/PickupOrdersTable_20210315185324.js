                                ...
                                <Table  id="datatable" data-toolbar="#bootstrap-table-toolbar" className="datatables-demo table table-striped table-bordered" style={{tableLayout: "auto"}}>
                                    ...
                                    { searchValue.map((item,id) => {
                                       ...
                                       <td className="actions-view" style={{textAlign:"center"}}><button type="button" id={item.Pushid} onClick={onClickDunzo} className="btn btn-primary btn-md">{"Reassign"}</button></td>
                                         ...
                                         <td className="actions-view" style={{textAlign:"center"}}><button type="button" id={item.Pushid} onClick={onClickShadowFx} className="btn btn-primary btn-md">{"Reassign"}</button></td> */}
