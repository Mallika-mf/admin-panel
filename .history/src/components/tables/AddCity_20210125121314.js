      ...
      <Fragment>
        ...
        <Row>
            ...
            <Card>
                ...
                <div className="col-sm-8">
                <input type="number" className="form-control" name="price" placeholder="Delivery Base Price" value={state.price} onChange={onChangeHandler}/>
                <div className="clearfix"></div>
                </div>
                </Row>
                ...
                <div className="col-sm-8">
                <input type="number" className="form-control" name="base" placeholder="Delivery Base KM" value={state.base} onChange={onChangeHandler}/>
                <div className="clearfix"></div>
                </div>
                </Row>
