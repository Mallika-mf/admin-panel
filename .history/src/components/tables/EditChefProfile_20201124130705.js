...
const EditChefProfileDetail = (props) => {
 ...
 useEffect(()=>{
  var latid=window.sessionStorage.getItem('lat');
  var lngid=window.sessionStorage.getItem('lnd');
  setLatitude(latid)
  setLong(lngid)
...
if(imageAsUrl!=="" && imageAsUrl!==undefined){
    ...
    <Fragment>
      ...
      <Container fluid={true}>
        ...
        <Row className="form-row">
          ...
          <Col className="form-group col-md-3">{latitide+",,"+long}
