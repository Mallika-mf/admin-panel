...
import { Container, Row, Col, Button, CardHeader, CardBody, Input, Card } from "reactstrap";
...
<Modal show={show} onHide={handleClose}>
        ...
        <Modal.Footer>
          ...
          <Col className="form-group col-md-3">
                                <input type="text" placeholder="Eg:Jeera Rice"/>
                            </Col>
                            <Col className="form-group col-md-3">
                                <input type="number" placeholder="Eg:150"/>
                            </Col>
                        </Row>
                        </CardBody>
                    </Card>
