     ...
     const printDocument=(event)=> {  
        ...
        html2canvas(input)  
          .then((canvas) => {  
            ...
            pdf.save("PickupOrders.pdf");  
          });  
      } 
    return (
        <Fragment>
            <BreadCrumb parent={<Home/>} subparent="Order Management" title="Pickup Orders"/>
            <Container fluid={true}>
               ...
               <CardHeader>
                ...
                <div className="col-md-5" style={{margin: "1%"}}>
                 ...
                 <div className="col-md-9 text-right" style={{margin: "3%"}}>
                <div className="dt-buttons btn-group">       
                <Button onClick={printDocument} variant="contained" color="primary"><span color="white">PDF</span></Button> 
                <ReactHTMLTableToExcel  
                className="btn btn-info"  
                table="datatable"  
                filename="PickupOrders"  
                sheet="PickupOrders"  
                buttonText="Excel" />
                <iframe
                    id="iDatatable"
                    src="/table/pickup-order"
                    style={{ display: 'none' }}
                    title="Receipt"
                />
