...
.once('value', function(snapshot){
    if(snapshot.exists()){
            ...
            snapshot.forEach(snap=>{
              ...
              content.map(item=>{
                ...
                if(item.Doc7===undefined){
                    item.Doc7=""
                }
                if(item.Doc6===undefined){
                    item.Doc6=""
                }
                if(item.Doc5===undefined){
                    item.Doc5=""
                }
                if(item.Doc4===undefined){
                    item.Doc4=""
                }
                if(item.Doc3===undefined){
                    item.Doc3=""
                }
                if(item.Doc2===undefined){
                    item.Doc2=""
                }
                if(item.Doc1===undefined){
                    item.Doc1=""
                }
                if(item.Reciept===undefined){
                    item.Reciept=""
                }
                ...
                if(item.RCNumber===undefined){
                    item.RCNumber=""
                }
                if(item.INumber===undefined){
                    item.INumber=""
                }
                if(item.VName===undefined){
                    item.VName=""
                }
                if(item.Remarks===undefined){
                    item.Remarks=""
                }
                if(item.BranchAddress===undefined){
                    item.BranchAddress=""
                }
                if(item.BranchName===undefined){
                    item.BranchName=""
                }
                if(item.IFSC===undefined){
                    item.IFSC=""
                }
                if(item.AccountNumber===undefined){
                    item.AccountNumber=""
                }
                if(item.AccountName===undefined){
                    item.AccountName=""
                }
                if(item.CPassword===undefined){
                    item.CPassword=""
                }
                ...
                if(item.AlternateNumber===undefined){
                    item.AlternateNumber=""
                }
                if(item.MobileNumber===undefined){
                    item.MobileNumber=""
                }
                if(item.Maritial===undefined){
                    item.Maritial=""
                }
    ...
    const excludeSearch = ["UserId","Name","FName"]
