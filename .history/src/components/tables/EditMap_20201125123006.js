...
this.setState( {
  ...
  .once('value').then(function(snapshot){
      ...
      this.setState((state, val) => {
        return {
           name:state.name+val.Name,
          number:state.number+val.MobileNumber,
          email:state.email+val.Email,
          deliveryTime:state.deliveryTime+val.DeliveryTime,
          costForTwo:state.costForTwo+val.CostTwo,
          closeTime:state.closeTime+val.Close,
          openTime:state.openTime+val.Open
        };
      });
      ...
      <Container fluid={true}>
        <Row className="form-row" style={{ marginTop: "3%" }}>
          <Col className="form-group col-md-6">
            ...
            <Row>
              <Col className="col-lg-6 col-md-5 col-sm-5">{console.log(this.state.search)}
                <Input type="text" defaultValue={this.state.search} onChange={(event)=>this.onChangeSearchHandler(event)} className="form-control" />
              </Col>
        ...
        <Row className="form-row">
          <Col className="form-group col-md-3">
            ...
            <input defaultValue={this.state.name} disabled className="form-control"/>
            <div className="clearfix"></div>
          </Col>
        </Row>
        ...
        <Row className="form-row">
          <Col className="form-group col-md-3">
            ...
            <Input type="number" defaultValue={this.state.number} disabled  className="form-control" />
            <div className="clearfix"></div>
          </Col>
          <Col className="form-group col-md-3">
            <label className="form-label">EmailId <span style={{ color: "red" }}>*</span></label>
            <Input type="email" defaultValue={this.state.email} disabled  className="form-control" />
            <div className="clearfix"></div>
          </Col>
        </Row>
        <Row className="form-row">
          <Col className="form-group col-md-3">
            ...
            <input type="number" defaultValue={this.state.deliveryTime} onChange={this.onChangeHandler} className="form-control"/>
            <div className="clearfix"></div>
          </Col>
        </Row>
        <Row className="form-row">
          <Col className="form-group col-md-3">
            ...
            <input type="number"  defaultValue={this.state.costForTwo} onChange={this.onChangeHandler} className="form-control"/>
            <div className="clearfix"></div>
          </Col>
        </Row>
        <Row className="form-row">
          <Col className="form-group col-md-3">
            ...
            <select defaultValue={this.state.cuisine} onChange={this.onChangeCuisine} className="form-control">
              <option defaultValue="Select">Select</option>
              {cuisineName.map((item, id) => <option key={id} defaultValue={item.PushId}>{item.Name}</option>)}
            </select>
            <div className="clearfix"></div>
          </Col>
          {/* {showTable===true? */}
        ...
        <Row className="form-row">
          <Col className="form-group col-md-3">
            ...
            <select defaultValue={this.state.foodCategory} onChange={this.onChangeFoodCategory} className="form-control">
              <option defaultValue="Select">Select</option>
              {this.state.foodType.map((item, id) => <option key={id} defaultValue={item.PushId}>{item.Name}</option>)}
        ...
        <Row className="form-row">
          <Col className="form-group col-md-3">
            ...
            <Input type="time" defaultValue={this.state.openTime} onChange={this.onChangeHandler} className="form-control" />
            <div className="clearfix"></div>
          </Col>
          <Col className="form-group col-md-3">
            <label className="form-label">Close Time <span style={{ color: "red" }}>*</span></label>
            <Input type="time" defaultValue={this.state.closeTime} onChange={this.onChangeHandler} className="form-control" />
            <div className="clearfix"></div>
          </Col>
        </Row>
        {/* <Row>
