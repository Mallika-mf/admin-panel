            ...
            <Container fluid={true}>
              ...
              <Col className="form-group col-md-6">
                ...
                <div className="clearfix"></div>
                    ...
                    <input type="text" className="form-control" id="name" value={} onChange={} placeholder="Cuisine Name"/>
                     <div className="clearfix"></div>
                    </div>
                    </Row>
                    <Row style={{margin:"1%"}}>
                     <div className="col-sm-10 ml-sm-auto">
                     <button type="submit" id="submit" onClick={} className="btn btn-primary">Submit</button>
                     </div>
                   </Row>
