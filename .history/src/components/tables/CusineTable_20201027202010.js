...
// import { Database, ShoppingBag, MessageCircle, User,UserPlus, Layers, ShoppingCart,  ArrowDown, Pocket, Monitor, Truck,BarChart,DollarSign,Percent,Headphones} from 'react-feather';
     ...
     const printDocument=(event)=> {  
        ...
        html2canvas(input)  
          .then((canvas) => {  
            ...
            pdf.save("Cuisines.pdf");  
          });  
      }
    return (
        <Fragment>
            <BreadCrumb parent={<Home/>} subparent="Food Management" title="Cusines List"/>
                ...
                <div className="col-md-5" style={{margin: "1%"}}>
                    <div className="form-group col-md-6">
                         <label className="form-label">Search <span style={{color: "red"}}>*</span></label>
                             <input type="text"  value={searchTerm} onChange={onChangeHandler}  required="" className="form-control" placeholder="Search for cusines" title="Type in a name"/>
                                    ...
                                    { searchValue.filter(orders =>
                                            orders.Name.includes(searchTerm)).map((item,id) => {
                                                return(
                                                    ...
                                                    {/* <td className="item_pushid" style={{display:"none"}}><textarea type="text" class="crop" rows="1" cols="30">{item.PushId}</textarea></td> */}
                                                     </tr>
                                                     )
