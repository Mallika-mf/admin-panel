...
const ChefProfile = () => {
    ...
    const onChangeFoodItemName = (event) =>{
        ...
        setSearchItem(event.target.value.toLowerCase().trim())
    }
    return (
        <Fragment>
                                                ...
                                                {foodItems.filter(order=>order.Name.toString().toLowerCase().includes(searchItem)).map((items, id) => {
                                                    return (
                                                        <tr key={id}>
                                                            ...
                                                            <td><Button type="button" id={items.PushId} onClick={onSaveNameHandler} className="warning"><Check  size={20} /></Button></td>                                                            <td>{items.Category}</td>
                                                            ...
                                                            <td><Button type="button" className="warning" id={items.PushId} onClick={onSaveDetailsHandler}><Check  size={20} /></Button></td>                                                            {Object.keys(items.Portions).length === 0 ?
                                                                <td>{""}</td> :
                                                                <>
                                                            ...
                                                            <td><Button type="button" className="warning" id={items.PushId} onClick={onSaveHandler}><Check  size={20} /></Button></td>
                                                            <td>{items.STime}</td>
                                                            <td>{items.ETime}</td>
                                                                ...
                                                                <tr key={id}>
                                                                    {items !== undefined ?
                                                                        <>
                                                                            ...
                                                                            <td><Button type="button" className="warning" id={items.PushId} onClick={onOfferSaveHandler} ><Check size={20} /></Button></td>
                                                                            <td>{items.STime}</td>
                                                                            <td>{items.ETime}</td>
                                                                            {items.Status === "Active" ?
                                                                                <td><div style={{ position: "relative", maxWidth: "50%", maxHeight: "50%" }}>
