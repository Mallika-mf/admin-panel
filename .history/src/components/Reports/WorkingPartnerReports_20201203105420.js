                                     ...
                                     {recordsAfterPagingAndSorting().map((item,id)=>{
                                      ...
                                      {recordsAfterDateFilteration().map((item,id)=>{
                                                      return(
                                                         ...
                                                         <td className=""><img src={item.Doc2} alt="doc1" target="_blank">View</img></td>
                                                         <td className=""><img src={item.Doc3} alt="doc1" target="_blank">View</img></td>
                                                         <td className=""><img src={item.Doc4} alt="doc1" target="_blank">View</img></td>
