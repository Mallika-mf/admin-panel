              ...
              <Row>
                <Col sm="12">
                  <Card>
                    ...
                    <div data-toolbar="#bootstrap-table-toolbar" className="table-responsive text-nowrap datatables-demo table table-striped table-bordered" style={{overflow:"auto"}}>
