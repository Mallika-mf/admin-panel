...
app.database().ref().child('-M7Rt3hrXVXrmglMhgMb').orderByChild('Status').equalTo('Active').on('value',snapshot=>{
  let content = []
  let citysnap
 ...
 const printDocument=(event)=> {  
  ...
  console.log(userid)
    app.database().ref().child("-M7Rt3hrXVXrmglMhgMb").child(userid).child("Status").set("InActive")
