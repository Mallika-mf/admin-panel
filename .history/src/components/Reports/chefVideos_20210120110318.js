...
app.database().ref().child('-M9w7myL8vcDXGJFBllC').orderByChild('Status').equalTo('Active').on('value',snapshot=>{
  let content = []
  let citysnap
 ...
 const printDocument=(event)=> {  
  ...
  console.log(userid)
    app.database().ref().child("-M9w7myL8vcDXGJFBllC").child(userid).child("Status").set("InActive")
