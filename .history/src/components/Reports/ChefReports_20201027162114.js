                                ...
                                <Table id="datatable">
                                    ...
                                    <tbody>
                                            ...
                                            .map((item,id)=>{ 
                                                    ...
                                                    <td className="text-primary"><b>{item.Catering}</b></td>:
                                                    <td className="text-primary"><b></b></td>
                                                  }
                                                   
                                                    <td className="" style={{ fontSize: "25px", fontWeight: "bold"}}><button type="button" id={item.UserId} onClick={onClickSearchHandler} className="btn btn-success btn-md">{"View"}</button></td>
                                                    <td className="" style={{ fontSize: "25px", fontWeight: "bold"}}><button type="button" id={item.UserId} onClick={onClickDeleteHandler} className="btn btn-danger btn-md">{"Delete"}</button></td>
