                                                ...
                                                {foodItems.map((items, id) => {
                                                    return (
                                                        <tr key={id}>
                                                            ...
                                                            <td><input type="number" id={items.PushId} value={items.Name} onChange={onChangeNameHandler} className="price" /></td>
                                                            <td><Button type="button" className="warning"><Check id={items.PushId} onClick={onSaveNameHandler} size={20} /></Button></td>                                                            <td>{items.Category}</td>
                                                            <td>{items.CuisineName}</td>
                                                            <td><input type="number" id={items.PushId} value={items.Details} onChange={onChangeDetailsHandler} className="price" /></td>
                                                            <td><Button type="button" className="warning"><Check id={items.PushId} onClick={onSaveDetailsHandler} size={20} /></Button></td>                                                            {Object.keys(items.Portions).length === 0 ?
                                                                <td>{""}</td> :
                                                                <>
