...
app.database().ref().child('-M7iJQbZPZ5GkINRW7U1').orderByChild('Status').equalTo('Active').on('value',snapshot=>{
  let content = []
  let citysnap
 ...
 const printDocument=(event)=> {  
  ...
  console.log(userid)
    app.database().ref().child("-M7iJQbZPZ5GkINRW7U1").child(userid).child("Status").set("InActive")
