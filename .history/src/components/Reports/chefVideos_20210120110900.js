...
app.database().ref().child('-M9w7Zq9xfj87uqB2Se8').orderByChild('Status').equalTo('Active').on('value',snapshot=>{
  let content = []
  let citysnap
 ...
 const printDocument=(event)=> {  
  ...
  console.log(userid)
    app.database().ref().child("-M9w7Zq9xfj87uqB2Se8").child(userid).child("Status").set("InActive")
