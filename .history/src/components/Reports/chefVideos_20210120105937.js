...
app.database().ref().child('-M9w7fM9sj5F5fjaTVgS').orderByChild('Status').equalTo('Active').on('value',snapshot=>{
  let content = []
  let citysnap
 ...
 const printDocument=(event)=> {  
  ...
  console.log(userid)
    app.database().ref().child("-M9w7fM9sj5F5fjaTVgS").child(userid).child("Status").set("InActive")
