        ...
        .once('value', function (snapshot) {
          if (snapshot.exists()) {
            ...
            snapshot.forEach(snap => {
              if (snap.val().UserName.exists()!==undefined) {
  ...
  const printDocument = (event) => {
    ...
    html2canvas(input)
      .then((canvas) => {
        ...
        pdf.save("CorporateOrderReport.pdf");
      });
  }
  return (
    <Fragment>
              ...
              <div className="col-md-11 text-right" style={{ marginTop: "-5%", marginBottom: "3%" }}>
                <div className="dt-buttons btn-group">
                  ...
                  <ReactHTMLTableToExcel
                    ...
                    table="datatable"
                    filename="CorporateOrderReport"
                    sheet="CorporateOrderReport"
                    buttonText="Excel" />
                  <iframe
                    id="iDatatable"
                    src="/reports/corporate-order-report"
                    style={{ display: 'none' }}
                    title="Receipt"
                  />
...
export default CorporateOrderReport;