...
app.database().ref().child('-M9w7qfvWoy4sRUCqcGQ').orderByChild('Status').equalTo('Active').on('value',snapshot=>{
  let content = []
  let citysnap
 ...
 const printDocument=(event)=> {  
  ...
  console.log(userid)
    app.database().ref().child("-M9w7qfvWoy4sRUCqcGQ").child(userid).child("Status").set("InActive")
