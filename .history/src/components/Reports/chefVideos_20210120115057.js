...
// app.database().ref().child('-MCpEZ_wWMgAEOvfTNt0').orderByChild('Status').equalTo('Active').on('value',snapshot=>{
//   let content = []
//   let citysnap
...
//       })
 ...
 const printDocument=(event)=> {  
  ...
  console.log(userid)
    app.database().ref().child("-MCpEZ_wWMgAEOvfTNt0").child(userid).child("Status").set("InActive")
