              ...
              <Row>
                <Col sm="12">
                  <Card>
                    ...
                    <>
                      ...
                      <div className="dt-buttons btn-group">
                            ...
                            <ReactHTMLTableToExcel
                              className="btn btn-info"
                              table="datatable1"
                              filename="ChefMFCashReport"
                              sheet="ChefMFCashReport"
                              buttonText="Excel" />
                            <iframe
                              id="iDatatable1"
                              src="/reports/chef-reports"
                    ...
                    <div data-toolbar="#bootstrap-table-toolbar" className="table-responsive text-nowrap datatables-demo table table-striped table-bordered">
                      <Table id="datatable1" className={classes.table} >
                        <TableHead>
                          <TableRow>
                            ...
                            <TableCell scope="col">  Transaction Id</TableCell>
                            <TableCell scope="col"> Transaction Name</TableCell>
                            <TableCell scope="col"> Transaction Type	</TableCell>
                            <TableCell scope="col"> Generated	</TableCell>
                            <TableCell scope="col"> Status	</TableCell>
                          </TableRow>
                        </TableHead>
                        <TableBody>
                          ...
                          {mfCash.map((item, id) => {
                            return (
                              <TableRow key={id}>
                                ...
                                <TableCell className="">{item.TransactionName}</TableCell>
                                <TableCell className="">{item.TransactionType}</TableCell>
                                <TableCell className="">{item.Generated}</TableCell>                               
                    ...
                    <div className="row">
                                        <div className="form-group col-md-12">
                                            <Button type="button" onClick={onClickMfCashBack} className="form-control">Back</Button>
                                            <div className="clearfix"></div>
                                        </div>
                                    </div>
