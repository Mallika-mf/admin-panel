...
const WorkingPartnerSettlementReport = (props) => {
  const pages = [5,10,25]
            ...
            <Container fluid={true}>
                <Row>
                    ...
                    <div className="form-group col-md-6">
                         <label className="form-label" htmlFor="searchSubscription">Search </label>
                ...
                table="datatable"  
                filename="WorkingPartnerSettelment"  
                sheet="WorkingPartnerSettelment"  
                buttonText="Excel" />
                <iframe
                    id="iDatatable"
                    src="/reports/working-partner-settlement"
                    style={{ display: 'none' }}
                    title="Receipt"
                />
...
export default WorkingPartnerSettlementReport;