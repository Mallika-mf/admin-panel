...
app.database().ref().child('CloudKitchen').orderByChild('Catering').equalTo('Yes').on('value',snapshot=>{
  let content = []
  let citysnap
 ...
 const printDocument=(event)=> {  
  ...
  let userid = event.target.id
    app.database().ref().child("CloudKitchen").child(userid).child("Paid").remove()
                                    ...
                                    {active.map((item,id)=>{
                                                    return(
                                                       ...
                                                       <td >{item.Paid}</td>
                                                        ...
                                                        <td ><button id={item.UserId} onClick={ApprovedChefHandler}>Remove Paid</button></td>
                                                        </tr>
                                                    )})}
                                                    </tbody>
