  ...
  const [filterfn,setFilterFn] = useState({fn : items=> {return items;}})
    ...
    useEffect(()=>{ 
        try{
            ...
            database.ref().child("DeliveryPartner").orderByChild("Created").equalTo(today)
...
const recordsAfterDateShow= () => {
  return filterfn.fn(deliveryShow)
}
       return (
        <Fragment>
                                      ...
                                      {recordsAfterPagingAndSorting().map((item,id)=>{
                                                  console.log(item.Address)
                                                      return(
                                                         ...
                                                         <td className=""><a href={item.Doc1} target="blank">View</a></td>
                                                         <td className=""><a href={item.Doc2} target="blank">View</a></td>
                                                         <td className=""><a href={item.Doc3} target="blank">View</a></td>
                                                         <td className=""><a href={item.Doc4} target="blank">View</a></td>
                                                         <td className=""><a href={item.Doc5} target="blank">View</a></td>
                                                         <td className=""><a href={item.Doc6} target="blank">View</a></td>
                                                         <td className=""><a href={item.Doc7} target="blank">View</a></td>
                                        ...
                                        <tbody>
                                        {recordsAfterDateShow().map((item,id)=>{
                                                    console.log(item.Address)
                                                        return(
                                                            <tr key={id}> 
                                                            <td>{id+1}</td>    
