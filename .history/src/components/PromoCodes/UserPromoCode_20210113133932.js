...
<div className="form-group col-md-4">
    ...
    <input type="date"  value={startDate} onChange={onChangeStartDate} className="form-control" placeholder=""/>
    <div className="clearfix"></div>
<label className="form-label">End Date <span style={{color: "red"}}>*</span></label>
    <input type="date"  value={endDate} onChange={onChangeEndDate} className="form-control" placeholder=""/>
    <div className="clearfix"></div>
</div>
</div>
                                                            <div className="form-group row">
