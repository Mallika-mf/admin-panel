...
// var ppushid=[];
    useEffect(()=>{
        let name=sessionStorage.getItem('promocodeStatus')
        setSname(name)
...
const onSubmitHandler=(event)=>{
    ...
    firebaseref.child("StartDate").set(String(startDate));
    firebaseref.child("EndDate").set(String(endDate));
...
<div className="form-group col-md-4">
    ...
    <input type="date"  value={startDate} onChange={onChangeCountValue} className="form-control" placeholder=""/>
    <div className="clearfix"></div>
</div>
<label className="form-label">End Date <span style={{color: "red"}}>*</span></label>
    <input type="date"  value={endDate} onChange={onChangeCountValue} className="form-control" placeholder=""/>
    <div className="clearfix"></div>
</div>
</div>
                                                            <div className="form-group row">
