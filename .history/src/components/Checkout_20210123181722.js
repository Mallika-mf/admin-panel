									...
									{this.state.showPromocode === true ?
										<>
											<InputGroup className="input-group-sm mb-2">
												...
												<InputGroup.Append>
													<Button variant="primary" type="button" onClick={this.handlePromo} id="button-addon2"><Icofont icon="sale-discount" disbaled={this.state.promocode.length === 0||this.state.promocodeFail===true}/> APPLY</Button>
												</InputGroup.Append>
											</InputGroup>
										</> :
