                                        ...
                                        {recordsAfterPagingAndSorting().map((item, id) => {
                                            return (
                                                <tr key={id}>
                                                    ...
                                                    <td className="" style={{ fontSize: "25px", fontWeight: "bold" }}><button type="button" id={item.data+","+item.UserId} onClick={onSaveHandler} className="btn btn-primary btn-md">Save</button></td>
