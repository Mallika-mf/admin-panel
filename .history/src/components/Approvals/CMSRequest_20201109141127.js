...
const ChefPayouts = () => {
    ...
    const onSaveHandler = (event) =>{
        ...
        let userid = arrData[1]
        let address = arrData[2]
        let reason = arrData[3]
        console.log(pushid)
        console.log(userid)
        console.log(address)
        console.log(reason)
                                        ...
                                        {recordsAfterPagingAndSorting().map((item, id) => {
                                            return (
                                                <tr key={id}>
                                                    ...
                                                    <td className="" style={{ fontSize: "25px", fontWeight: "bold" }}><button type="button" id={item.data+","+item.UserId+","+item.Address+","+item.Reason} onClick={onSaveHandler} className="btn btn-primary btn-md">Save</button></td>
                                                    <td className="" style={{ fontSize: "25px", fontWeight: "bold" }}><button type="button" id={item.data} onClick={onDeleteHandler} className="btn btn-secondary btn-md">Delete</button></td>
                                                </tr>
                                            )
