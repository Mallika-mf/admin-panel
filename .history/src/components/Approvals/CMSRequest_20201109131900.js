                                        ...
                                        {recordsAfterPagingAndSorting().map((item, id) => {
                                            return (
                                                <tr key={id}>
                                                    ...
                                                    <td className="" style={{ fontSize: "25px", fontWeight: "bold" }}><button type="button" id={item.key} onClick={onSaveHandler} className="btn btn-primary btn-md">Save</button></td>
                                                    <td className="" style={{ fontSize: "25px", fontWeight: "bold" }}><button type="button" id={item.key} onClick={onDeleteHandler} className="btn btn-secondary btn-md">Delete</button></td>
                                                </tr>
                                            )
