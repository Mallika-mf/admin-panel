...
const LocationChangeApprovals = () => {
    ...
    const onSaveHandler=(event)=>{
        ...
        app.database().ref().child("Requests").child(pushid).remove();
         if(localFood!==undefined&& localFood==="Yes"){
            app.database().ref().child("LocalFood").child(cityId).child(userid).child("Location").set(location);
         }else{
            app.database().ref().child(cityId).child(userid).child("Location").set(location);
