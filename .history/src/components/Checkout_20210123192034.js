								...
								<div className="bg-white rounded shadow-sm p-4 mb-4">
									...
									<Row>
										{get(userAddresses, 'length', 0) > 0 ?
										 ...
										 <button onClick={this.handleAddressSelectionSubmit} className="btn float-right" style={{ background: "#FFFFFF", color: "#E41C39", border: "solid 2px #E41C39", marginRight: "0%", marginTop: "5%", fontWeight: 'bold' }} >Add New Address</button>
                                                {addressError ?
