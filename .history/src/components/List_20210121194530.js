			         ...
			         <Container>
			            <Row className="d-none-m">
			               <Col md={12}>
								...
								<Dropdown className="float-right">
								 <div className="product-sort d-flex justify-content-between align-items-center float-right">
                  <div className="sort d-flex align-items-center" variant="outline-info">
				  <Dropdown.Toggle variant="outline-info">
                    <span className="m-right-15 text-theme">Sort By: </span>
					</Dropdown.Toggle>
                    <div className="dropdown-menu-right shadow-sm border-0">
