								...
								<div className="bg-white rounded shadow-sm p-4 mb-4">
									...
									<Row>
										{get(userAddresses, 'length', 0) > 0 ?
										 ...
										 <button onClick={this.handleAddressSelectionSubmit} className="btn btn-sm btn-primary mr-2" style={{ background: "#FFFFFF", color: "white", border: "solid 2px #E41C39", marginRight: "0%", marginTop: "5%", fontWeight: 'bold',height:"50px",float:"right" }} >Add New Address</button>
                                                {addressError ?
