            ...
            <Row>
              ...
              <Col md={4}>
                <div className="generator-bg rounded shadow-sm mb-4 p-4 osahan-cart-item">
                  ...
                  <div className="mb-2 bg-white rounded p-2 clearfix">{console.log(`im here${Date.now()},${localStorage.getItem("ChefId")},${parseFloat(total).toFixed(2)},${parseFloat(taxes).toFixed(2)}`)}
