                    ...
                    {contacts.map((item,id)=>{
                        return(
                            <div key={id}>
                                ...
                                <div className="  mb-4 media align-items-center"  ><Trash id={item.PushId} onClick={onDeleteHandler} style={{color:"orange",position:"absolute",right:"11%",float:"right"}} size={20}/><div style={{float:"right",clear:"right",width:"300px"}} ><img src={images} style={{height:"40px",width:"40px",position:"absolute",right:"7%",marginTop:"-20px"}} className="media align-items-center float-right"  alt=""></img>
                                ...
                                <div className="float-right chat-message-right mb-4 align-items-center  "><Trash id={item.PushId} onClick={onDeleteHandler} style={{color:"orange"}} size={20}/><div><img src={images} style={{height:"40px",width:"40px",position:"absolute",right:"10%",marginTop:"-20px"}}  alt=""></img>
                                <div className="text-muted small text-nowrap mt-2" ></div></div>
