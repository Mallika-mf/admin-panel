                    ...
                    {contacts.map((item,id)=>{
                        return(
                            <div key={id}>
                                ...
                                <div className="float-right chat-message-right mb-4 align-items-center  "><div><img src={images} style={{height:"40px",width:"40px",position:"absolute",right:"10%",marginTop:"-20px"}}  alt=""></img>
                                <div className="text-muted small text-nowrap mt-2" ></div></div>
