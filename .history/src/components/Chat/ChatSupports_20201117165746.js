                    ...
                    {contacts.map((item,id)=>{
                        return(
                            <div key={id}>
                                ...
                                <div className="  mb-4 media align-items-center"  ><div style={{float:"right",clear:"right",width:"300px"}} ><img src={images} style={{height:"40px",width:"40px",position:"absolute",right:"7%",marginTop:"-20px"}} className="media align-items-center float-right"  alt=""></img>
                                ...
                                <button><Trash id={item.PushId} onClick={onDeleteHandler} size={15}/></button></div>

                                :item.Name==="Support"&&item.Type!=="Text"?
                    
                                <div className="float-right chat-message-right mb-4 align-items-center  "><div><img src={images} style={{height:"40px",width:"40px",position:"absolute",right:"7%",marginTop:"-20px"}}  alt=""></img>
                                <div className="text-muted small text-nowrap mt-2" ></div></div>
                                ...
                                {item.Date+','+item.Time}</div><button><Trash id={item.PushId} onClick={onDeleteHandler} size={15}/></button></div>
                               :item.Type==="Text"?
                                <div className=" mb-4 media align-items-center"><button><Trash id={item.PushId} onClick={onDeleteHandler} size={15}/></button><div><img src={images} style={{height:"40px",width:"40px"}} className=" ui-w-40 rounded-circle" alt=""></img>
                                <div className="text-muted small text-nowrap mt-2"></div></div>
                                ...
                                {item.Date+','+item.Time}</div></div>:<button><Trash id={item.PushId} onClick={onDeleteHandler} size={15}/></button>
