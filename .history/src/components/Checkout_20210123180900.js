									...
									{this.state.showPromocode === true ?
										<>
											<InputGroup className="input-group-sm mb-2">
												...
												<Form.Control type="text" onClick={this.handlePromo} placeholder="Enter promo code" />
												<InputGroup.Append>
													<Button variant="primary" type="button" onClick={this.handlePromo} id="button-addon2"><Icofont icon="sale-discount" disbaled={this.state.promocode.length === 0}/> APPLY</Button>
												</InputGroup.Append>
											</InputGroup>
										</> :
