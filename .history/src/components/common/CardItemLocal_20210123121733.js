            ...
            return (
                <div className="list-card bg-white h-100 rounded overflow-hidden position-relative shadow-sm">
                   <div className="list-card-image">
                      ...
                      <Link to={this.props.linkUrl}>
                      <div className="card-img-top img-responsive" style={{height : '200px', width : '100%', overflow : 'hidden' , alignItems : 'center'}}>
                          <Image src={this.props.image} style={{maxWidth:"100%",width:"200px",objectFit:"cover"}} className={this.props.imageClass} alt={this.props.imageAlt} />
                     </div>
                      </Link>
                   </div>
            ...
            return (
                <div className="list-card bg-white h-100 rounded overflow-hidden position-relative shadow-sm">
                   <div className="list-card-image">
                      ...
                      <div className="card-img-top img-responsive" style={{height : '200px', width : '100%', overflow : 'hidden' , alignItems : 'center'}}>
                          <Image src={this.props.image} style={{maxWidth:"100%",width:"150px",objectFit:"cover"}} className={this.props.imageClass} alt={this.props.imageAlt} />
                     </div>
