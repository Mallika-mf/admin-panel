...
class CardItem extends React.Component {
  render() {
    return (
      // // <div className="list-card bg-white h-100 rounded overflow-hidden position-relative shadow-sm" style={{borderRadius:"25px",boxShadow: "5px 5px 10px #888888"    }}>
      //   // <div >
      //     {/* {this.props.rating ? (
      ...
      //     // )}
          <button style={{ border: "none" }}> 
            <img
              ...
              onClick={this.props.onClickedPlans}
            />
           </button>
        // </div>
      ...
      //       </h6>
      //       {this.props.subTitle ? (
      //         <p className="text-gray mb-3" style={{ fontSize: "20px" }}>
      //           {this.props.subTitle}
      //         </p>
      //       ) : (
      //         ""
