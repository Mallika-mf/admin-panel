      ...
      <>
            ...
            <Row>
              <Col sm={12}>
                <h5 className="m-0" style={{ fontSize: "25px" }}>
                  ...
                  <Link to="partnerwithus">Work With Us</Link>
                </h5>
              </Col>
            </Row>
          </Container>
        ...
        <section className="footer pt-5 pb-5">
          <Container>
            <Row>
              <Col md={4} sm={12}>
                <h6 className="mb-3" style={{ textAlign: "justify" }}>
...
{/* >>>>>>> e1f3282275238d424e5f4b2b07c9431b2a2a07bf */}
                  <a
                    className="mr-1"
                    href="https://play.google.com/store/apps/details?id=mothers.food.motherfoodpartner"
                    target="_blank"
                    rel="noopener noreferrer"
                  >
                  ...
                  <a
                    href="https://apps.apple.com/us/app/mothers-food-home-chef/id1528883397"
                    target="_blank"
                    rel="noopener noreferrer"
                  >
                    <Image src="img/apple.png" alt="" fluid />
              ...
              <Col md={2} sm={3} xs={4} style={{ marginLeft: "-4%" }}>
                ...
                <ul>
                  ...
                  <li style={{ textAlign: "justify" }}>
                    <Link to="/ridewithus">Drive With Us</Link>
                  </li>
                  <li style={{ textAlign: "justify" }}>
              ...
              <Col md={2} sm={3} xs={6} style={{}}>
                ...
                <ul>
                  ...
                  <li style={{ textAlign: "justify" }}>
                    <Link to="/catering1">Caterers</Link>
                  </li>
                </ul>
              </Col>
            </Row>
          ...
          <div className="container">
            <Row>
              <Col xs={12}>
                <p
                  style={{ textAlign: "justify" }}
                  className={this.props.popularCHclassName}
                >
                  POPULAR CITIES
                </p>
                ...
                <p
                  style={{ textAlign: "justify" }}
                  className={this.props.popularFHclassName}
                >
                  POPULAR CUISINES
                </p>
                <div style={{ textAlign: "justify" }} className="search-links">
                  ...
                  <Link to="#"> Parsi Food </Link> |{" "}
                  <Link to="#"> Baking </Link> |<Link to="#">Items </Link>
                </div>
              </Col>
            </Row>
          </div>
