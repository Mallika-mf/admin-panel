...
const SearchInput = compose(
  withProps({
    googleMapURL: 'https://maps.googleapis.com/maps/api/js?v=3.exp&key=AIzaSyCPhxfpptoIc1yca5U8mXIigIajoERQCdE&libraries=geometry,drawing,places',
  ...
  return (
    <div className="map_autocomplete" style={{width: '100%', marginBottom: '30px'}}>
