...
{/* <<<<<<< HEAD */}
                ...
                <div style={{ textAlign: "justify" }} className="app">
                  ...
                  <a href = "https://play.google.com/store/apps/details?id=mothers.food.motherfoodpartner" target = "_blank" rel="noopener noreferrer"  className="mr-1">      
                    <Image src="img/google.png" alt="" fluid />
                  </a>
                  <a href = "https://apps.apple.com/in/app/mothers-food-home-chef/id1528883397" target = "_blank" rel="noopener noreferrer"  className="mr-1">      
