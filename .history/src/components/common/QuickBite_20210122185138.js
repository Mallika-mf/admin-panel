      	...
      	<div className={"p-3 border-bottom "+this.props.itemClass}>
		   {this.props.quantity===0?
	            <span className="float-right"> 
	              <Button variant='outline-secondary' onClick={this.prop.onAddClick} size="sm">ADD</Button>
	            </span>
	            :
	            <span className="count-number float-right">
	               <Button variant="outline-secondary" onClick={this.prop.onIncClicked} className="btn-sm left dec"> <Icofont icon="minus" /> </Button>
		   ...
		   <Media>
             ...
             <p className="mb-1">{this.props.detail} </p>
