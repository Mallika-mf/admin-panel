                    ...
                    <div className="container">
                        <div className="row align-items-center">
                            <div className="col-md-6">
                                <h2 className="display-4.5 text-left" style={{fontWeight:700,fontSize:"34pt"}}>What is the meaning <br />of the Cloud Kitchen?</h2>
...
Cloud Kitchens are a redesigned format of home chef’s regular kitchen with more hygiene and safety measures. Daily sanitization, weekly and monthly maintenance, regular surveys to keep up the hygiene levels are assured in Cloud kitchens. 
                            ...
                            <div className="col-md-6">
                                ...
                                <div className="img-shape-one" style={{marginTop:"3%"}}>
                                    <img src="./assets/img/blog.jpg" alt="" style={{maxWidth:"100%",width:"500px"}} />
                                </div>
            ...
            <div className="icon-boxes">
                <div className="container">
                    <div className="row">
                        <div className="col-lg-8 offset-lg-2 section-title" style={{marginTop:"5%"}}>
                            <h1><b>Latest Articles !</b></h1>
                            {/* <p>Need Single content here</p> */}
                        </div>
                        <div className="col-lg-4 col-md-6" style={{marginTop:"5%"}}>
                            <NavLink to='/news-detail-2'style={{color:"gray"}} >
                            <div className="card post--card " style={{border:"none",boxShadow: "0 4px 8px 0 rgba(0, 0, 0, 0.2)",borderRadius:"5px"}}>
                                <figure>
                                  <img src="../assets/img/blog-img-1.jpg" alt=""  style={{maxWidth:"100%",width:"350px", height:"auto"}}/>
                                </figure>
...
delicious food goes down the throat, that heavenly feeling can melt the soul.</p>
                        ...
                        <NavLink to='/news-detail-1'style={{color:"gray"}}>
                            <div className="card post--card " style={{border:"none",boxShadow: "0 4px 8px 0 rgba(0, 0, 0, 0.2)",borderRadius:"5px"}}>
                                <figure>
                                   <img src="../assets/img/blog-img-3.jpg" alt=""  style={{maxWidth:"100%",width:"350px", height:"auto"}}/>
                                </figure>
                                <div className="card-body">
                                    ...
                                    <p className="text-left">Cooking is an art and science of experimenting with savory, sweetness,  spices in ways that it brings
out a drooling essence, flavor, taste, smell, and gets you a smile.{""}{""}{""} <br/></p>
                                </div>
                            </div>
                            </NavLink>
                        </div>
...
unhygienic kitchen equipment, and rotten ingredients? 
 <br/><br/></p>
                        ...
                        <NavLink to='/news-detail-4' style={{color:"gray"}} >
                            <div className="card post--card " style={{border:"none",boxShadow: "0 4px 8px 0 rgba(0, 0, 0, 0.2)",borderRadius:"5px"}}>
                                <figure>
                                   <img src="../assets/img/blog-img-2.jpg" alt=""  style={{maxWidth:"100%",width:"350px", height:"auto"}}/>
                                </figure>
                                <div className="card-body">
 ...
 <br/><br/></p>
                        ...
                        <NavLink to='/news-detail-5' style={{color:"gray"}}>
                            <div className="card post--card " style={{border:"none",boxShadow: "0 4px 8px 0 rgba(0, 0, 0, 0.2)",borderRadius:"5px"}}>
                                <figure>
                                   <img src="../assets/img/blog-img-5.jpg" alt=""  style={{maxWidth:"100%",width:"350px", height:"auto"}} />
                                </figure>
                                <div className="card-body">
 ...
 <br/><br/></p>
                        ...
                        <NavLink to='/news-detail-6' style={{color:"gray"}}>
                            <div className="card post--card " style={{border:"none",boxShadow: "0 4px 8px 0 rgba(0, 0, 0, 0.2)",borderRadius:"5px"}}>
                                <figure>
                                   <img src="../assets/img/blog-img-6.jpg" alt=""  style={{maxWidth:"100%",width:"350px", height:"auto"}} />
                                </figure>
                                <div className="card-body">
                                    ...
                                    <p className="text-left">India is a land of  a variety of spices and flavors due to its multi-cultural nature. That deduces to Indian food being multi-cultural too. There is a variety of tasty, hygienic food that is made in every household in India.<br/><br/>
 </p>
                        ...
                        <NavLink to='/news-detail-7' style={{color:"gray"}}>
                            <div className="card post--card " style={{border:"none",boxShadow: "0 4px 8px 0 rgba(0, 0, 0, 0.2)",borderRadius:"5px"}}>
                                <figure>
                                   <img src="../assets/img/blog-img-7.jpg" alt=""  style={{maxWidth:"100%",width:"350px", height:"auto"}} />
                                </figure>
                                <div className="card-body">
 ...
 <br/><br/><br/></p>
                        ...
                        <NavLink to='/news-detail-8' style={{color:"gray"}}>
                            <div className="card post--card " style={{border:"none",boxShadow: "0 4px 8px 0 rgba(0, 0, 0, 0.2)",borderRadius:"5px"}}>
                                <figure>
                                   <img src="../assets/img/blog-img-8.jpg" alt=""  style={{maxWidth:"100%",width:"350px", height:"auto"}} />
                                </figure>
                                <div className="card-body">
                        ...
                        <NavLink to='/news-detail-9' style={{color:"gray"}}>
                            <div className="card post--card " style={{border:"none",boxShadow: "0 4px 8px 0 rgba(0, 0, 0, 0.2)",borderRadius:"5px"}}>
                                <figure>
                                   <img src="../assets/img/blog-img-9.jpg" alt=""  style={{maxWidth:"100%",width:"350px", height:"auto"}} />
                                </figure>
                                <div className="card-body">
                        ...
                        <NavLink to='/news-detail-10' style={{color:"gray"}}>
                            <div className="card post--card " style={{border:"none",boxShadow: "0 4px 8px 0 rgba(0, 0, 0, 0.2)",borderRadius:"5px"}}>
                                <figure>
                                   <img src="../assets/img/blog-img-10.jpg" alt=""  style={{maxWidth:"100%",width:"350px", height:"auto"}} />
                                </figure>
                                <div className="card-body">
                                    ...
                                    <p className="text-left">Fitness is all about maintaining a balanced lifestyle and healthy nutrition rather than the misconceived concept of having 
 </p>
                        ...
                        <NavLink to='/news-detail-11' style={{color:"gray"}}>
                            <div className="card post--card " style={{border:"none",boxShadow: "0 4px 8px 0 rgba(0, 0, 0, 0.2)",borderRadius:"5px"}}>
                                <figure>
                                   <img src="../assets/img/blog-img-11.jpeg" alt=""  style={{maxWidth:"100%",width:"350px", height:"auto"}} />
                                </figure>
                                <div className="card-body">
                        ...
                        <NavLink to='/news-detail-12' style={{color:"gray"}}>
                            <div className="card post--card " style={{border:"none",boxShadow: "0 4px 8px 0 rgba(0, 0, 0, 0.2)",borderRadius:"5px"}}>
                                <figure>
                                   <img src="../assets/img/blog-img-12.jpg" alt=""  style={{maxWidth:"100%",width:"350px", height:"auto"}} />
                                </figure>
                                <div className="card-body">
                        ...
                        <NavLink to='/news-detail-13' style={{color:"gray"}}>
                            <div className="card post--card " style={{border:"none",boxShadow: "0 4px 8px 0 rgba(0, 0, 0, 0.2)",borderRadius:"5px"}}>
                                <figure>
                                   <img src="../assets/img/blog-img-13.jpeg" alt=""  style={{maxWidth:"100%",width:"350px", height:"auto"}} />
                                </figure>
                                <div className="card-body">
                        ...
                        <div className="col-lg-4 col-md-6" style={{position:"relative",marginTop:"20px",marginBottom:"5%",outline:"none"}}>
                        <NavLink to='/news-detail-14' style={{color:"gray"}}>
                            <div className="card post--card " style={{border:"none",boxShadow: "0 4px 8px 0 rgba(0, 0, 0, 0.2)",borderRadius:"5px"}}>
                                <figure>
                                   <img src="../assets/img/blog-img-14.jpeg" alt=""  style={{maxWidth:"100%",width:"350px", height:"auto"}} />
                                </figure>
                                <div className="card-body">
