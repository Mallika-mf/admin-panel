                    ...
                    <NavLink to="/news-detail-22" style={{ color: "gray" }}>
                      ...
                      >
                        ...
                        <div className="card-body">
                          ...
                          <p className="text-left" style={{ fontSize: "15px" }}>
                          Indian cuisine and food are famous all over the world for their spicy taste, innovative ingredients, and nutritional value. A lot of times people living away from home working </p>                          
                         </div>
                      </div>
                    </NavLink>
