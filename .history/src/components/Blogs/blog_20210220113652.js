              ...
              <div className="container">
                <div className="row align-items-center">
                  <div className="col-md-6">
                    <h2
                      className="display-4.5 text-left"
                      style={{ fontWeight: 700, fontSize: "34pt" }}
                    >
                      What is the meaning <br />
                      of the Cloud Kitchen?
                    </h2>
                    <p className="text-left">
                      You must have heard about modern kitchens, open kitchen,
                      roof-top kitchens, and a lot more. But what is this cloud
                      kitchen? Let’s find out: Cloud Kitchens are a redesigned
                      format of home chef’s regular kitchen with more hygiene
                      and safety measures. Daily sanitization, weekly and
                      monthly maintenance, regular surveys to keep up the
                      hygiene levels are assured in Cloud kitchens.
                    </p>
                    <a
                      href="https://www.thefoodcorridor.com/2019/12/05/everything-you-need-to-know-about-cloud-kitchens-aka-ghost-kitchens-in-2020/#:~:text=Cloud%20kitchens%20are%20centralized%20licensed,prepare%20delivery-optimized%20menu%20items"
          ...
          <section className="features-area  p-top-55 p-bottom-50">
            <div className="icon-boxes">
              <div className="container">
                <div className="row">
                  <div
                    className="col-lg-8 offset-lg-2 section-title"
                    style={{ marginTop: "5%" }}
                  >
                    <h1>
                      <b>Latest Articles !</b>
                    ...
                    <NavLink to="/news-detail-7" style={{ color: "gray" }}>
                      ...
                      >
                        ...
                        <div className="card-body">
                          <h6 className="text-left">
                            <strong>
                              Celebrities and their favorite homemade dishes.
                            </strong>
                          </h6>
                          <ul className="post-meta d-flex">
                  ...
                  >
                    <NavLink to="/news-detail-18" style={{ color: "gray" }}>
                      ...
                      >
                        <figure>
                          <img
                            src="../assets/img/blog-img-18.jpg"
                            alt=""
                            style={{ maxWidth: "350px", height: "auto" }}
                          />
                        </figure>
                    ...
                    <NavLink to="/news-detail-19" style={{ color: "gray" }}>
                      ...
                      >
                        ...
                        <div className="card-body">
                          ...
                          <p className="text-left" style={{ fontSize: "15px" }}>
                          Leafy green vegetables form an important part of a healthy diet.Available all round the year these healthy greens boost metabolism and ensure the smooth functioning of our body </p>                          
                         </div>
                      </div>
                    </NavLink>
                  </div>
