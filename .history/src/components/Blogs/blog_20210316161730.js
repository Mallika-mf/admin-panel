                  ...
                  <NavLink to="/news-detail-24" style={{ color: "gray" }}>
                      ...
                      >
                        ...
                        <div className="card-body">
                          ...
                          <p className="text-left" style={{ fontSize: "15px" }}>
                          Clean eating is a lifestyle one has to adapt to maintain their health. But is clean eating always possible? Especially when you have a huge social circle where   </p>                    </div>
                    </NavLink>
                  </div>
