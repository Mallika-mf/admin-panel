              ...
              <div className="custom-upload">
                ...
                <div className="custom-upload-box d-flex">
                  <div className="upload-btn">
                    <a type="file" name="resume" onChange={this.resumeupload} className="btn btn-danger btn-icon icon-right" style={{background:"#E41C39",border:"#E41C39"}}>Choose Resume <FontAwesome icon="la la-cloud-upload" /></a>
                  </div>
