...
Sorry, your browser does not support inline SVG.</h1>
            ...
            <div className="intro-four bgimage" style={{width:"100%",height:"200px",backgroundImage:`url('../assets/img/cupcake2.jpg')`,marginRight:"-130px", textShadow: ".1em .1em rgba(0, 0, 0, 0.2)"}}>
