        ...
        <div className="col-lg-12">
          ...
          <form id="create-course-form">   
            ...
            <div className="form-group" style={{ textAlign: "justify" }}>
              ...
              <label style={{ textAlign: "justify" }} htmlFor="upload-button">
   
            <span style={{ textAlign: "justify" }} className="btn btn-danger btn-icon icon-right" style={{background:"#E41C39",border:"#E41C39"}}>Choose Resume <FontAwesome icon="la la-cloud-upload" /></span>
            <span style={{ textAlign: "justify" }}>PDF,Docs</span>
                    <span style={{ textAlign: "justify" }}>Max File Size: 5Mb</span>         
      </label>
                <input style={{ textAlign: "justify" }} type="file" id="upload-button" name="resume" ref={this.state.resume} style={{display:"none"}}  onChange={this.resumeupload} className="custom-upload" required/>
                {/* <div className="custom-upload-box d-flex">
