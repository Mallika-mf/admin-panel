      ...
      <div className="row">
        <div className="col-lg-12">
          ...
          <form id="create-course-form">   
            ...
            <span  className="btn btn-danger btn-icon icon-right" style={{background:"#E41C39",border:"#E41C39",height:"40px"}}>Choose Resume <FontAwesome icon="fas fa-cloud-upload-alt" /></span>
