...
class GeneralRules extends React.Component{
  ...
  render(){
    ...
    //   var style = {};
                    ...
                    <div className="row">
                        <div className="col-lg-12">
                            <div className="apply-form--header " >
                                ...
                                <p  style={{fontSize:"20px",color:'gray'}}>Submit your resume below to apply for the job.</p>
                            </div>
                        </div>
                    </div>
                </div>
      ...
      <div className="row">
        <div className="col-lg-12">
          <h4 className="border-bottom p-bottom-25 mb-40" style={{marginTop:"5%",marginBottom:"3%"}}>Personal Information</h4>
          <form id="create-course-form">   
            ...
            <h4 className="border-bottom p-bottom-25 m-bottom-50 m-top-70" style={{marginTop:"5%"}}>Academic Information</h4>
            ...
            <h4 className="border-bottom p-bottom-25 m-bottom-50 m-top-70" style={{margin:"5%"}}>Add Resume<span className="sup" style={{color:"red"}}>*</span></h4>
            <div className="form-group" style={{ textAlign: "justify",marginTop:"5%" }}>
              <div className="custom-upload" style={{ textAlign: "justify" }}>
              <label htmlFor="upload-button">
   
            <span  className="btn btn-danger btn-icon icon-right" style={{background:"#E41C39",border:"#E41C39",height:"40px",marginLeft:"-20%"}}>Choose Resume <FontAwesome icon="fas fa-cloud-upload-alt" /></span>
            <span style={{marginLeft:"20%",color:"gray"}}>PDF,Docs </span>
                    <span style={{marginLeft:"40%",color:"gray"}} >Max File Size: 5Mb</span>         
      </label>
            ...
            <h4 className="border-bottom p-bottom-25 m-bottom-50 m-top-70" style={{marginTop:"5%",marginBottom:"5%"}}>Additional Messages</h4>
            ...
            <div className="btns m-top-50" style={{marginTop:"5%"}}>
              <button type="submit" onClick={submit} className="btn btn-danger m-right-25" style={{background:"#E41C39"}}>Apply Now</button>
            </div>
        </div>
      </div>{/* end: .row */}
    </div>
