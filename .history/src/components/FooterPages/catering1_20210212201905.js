...
const Catering = () => {
    ...
    return (
        <Fragment>
            ...
            <div className="intro-four bgimage" style={{width:"100%",height:"200px",borderRadius:" 100% 0 100%  0",backgroundColor: "blue",marginRight:"-130px", textShadow: ".1em .1em rgba(0, 0, 0, 0.2)"}}>
