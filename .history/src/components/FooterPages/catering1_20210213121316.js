...
const Catering = () => {
    ...
    return (
        <Fragment>
            <div className='card' style={{backgroundImage:"../assets/img/cupcake.jpg"}}>
            ...
            <div className="intro-four bgimage" style={{width:"100%",height:"200px",borderRadius:"0 0 100% 100%",backgroundColor: "red",marginRight:"-130px", textShadow: ".1em .1em rgba(0, 0, 0, 0.2)"}}>
