          ...
          <form id="create-course-form">   
            ...
            <div className="form-group" style={{ textAlign: "justify" }}>
              <div className="custom-upload">
                <input type="file" name="resume" ref={this.state.resume} style={{display:"none"}} onChange={this.resumeupload} className="custom-upload" required/>
                <div className="custom-upload-box d-flex">
                  <div className="upload-btn">
                    <button onClick={e => this.state.resume.current && this.state.resume.current.click()} className="btn btn-danger btn-icon icon-right" style={{background:"#E41C39",border:"#E41C39"}}>Choose Resume <FontAwesome icon="la la-cloud-upload" /></button>
                  </div>
