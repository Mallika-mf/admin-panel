...
const About = () => {
  ...
  const onCloseModal = () => setOpen(false);
    ...
    return (
        ...
        <Modal open={open} onClick={onCloseModal} center className="modal fade" id="modal-center" tabIndex={-1} role="dialog" aria-labelledby="modal-centerLabel" aria-hidden="true">
