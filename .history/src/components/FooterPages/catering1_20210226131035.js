              ...
              <OwlCarousel
                ...
                >
                  <div className="item">
                    <CardItem
                    image="../assets/img/Basic.png"
                    onClickedBasic = {displayRazorpayBasic}
                  ...
                  <div className="item">
                    <CardItem
                     image="../assets/img/Advanced.png"
                     onClickedAdvanced = {displayRazorpayAdvanced}
                  ...
                  <div className="item">
                    <CardItem
                      image="../assets/img/Premium.png"
                      onClickedPremium = {displayRazorpayPremium}
                  ...
                  <div className="item">
                    <CardItem
                    image="../assets/img/PremiumPro.png"
                    onClickedPremiumPro = {displayRazorpayPremiumPro}
                    //   title="Example4"
                    //   subTitle="Some quick example text to build on the panel title and make up
                    // the bulk of the panel's content."
                    />
