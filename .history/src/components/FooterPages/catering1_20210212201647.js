...
const Catering = () => {
    ...
    return (
        <Fragment>
            ...
            <div className="intro-four bgimage" style={{width:"100%",height:"200px",borderRadius:"0 100% 100% 100%",backgroundColor: "gray",marginRight:"-130px", textShadow: ".1em .1em rgba(0, 0, 0, 0.2)"}}>
