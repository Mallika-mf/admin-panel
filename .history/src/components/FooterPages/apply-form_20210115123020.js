          ...
          <form id="create-course-form">   
            ...
            <div className="form-group" style={{ textAlign: "justify" }}>
              <div className="custom-upload">
                  <lable htmlFor="myphoto" style={{background:"#E41C39",border:"#E41C39"}}>Choose Resume <FontAwesome icon="la la-cloud-upload" /></lable>
                <input type="file" name="resume" id="myphoto" ref={this.state.resume} style={{display:"none"}} onChange={this.resumeupload} className="custom-upload" required/>
                <div className="custom-upload-box d-flex">
                  <div className="upload-btn">
                    {/* <a href=' ' className="btn btn-danger btn-icon icon-right" ></a> */}
                  </div>
