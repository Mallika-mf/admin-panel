  ...
  const onCloseModal = () => setOpen(false);
    ...
    return (
        ...
        <Fragment>
            ...
            <div className="card">
                 <section className="section-bg p-top-50 p-bottom-50" style={{background:"#ffffff"}}>
                    <div className="container">
                        <div className="row">
                            <div className="col-md-12 text-center" style={{marginTop:"4%"}}>
                                <h2 style={{color:"#E41C39"}}><b>Together at MothersFood </b></h2>
                            </div>
                            <div className="col-md-12 text-center" style={{marginTop:"1%",marginBottom:"3%"}}>
                ...
                <div className="bg_image_holder " >
                    <img src="./assets/img/team.png" alt="" style={{maxWidth:"100%",maxHeight:"200%"}}/>
                </div>
                <div className="intro-four--contents content_above" style={{marginTop:"-30%"}}>
                    <div className="container">
                        <div className="row">
                            <div className="col-lg-12 text-center">
                                <h1 className="display-3" style={{color:"#E41C39",maxWidth:"100%"}}>Why Mothers Food?</h1>
            ...
            <li className="m-bottom-30" style={{marginBottom:"10%",maxWidth:"100%"}}></li>
                           
                <section className="features-area  p-top-105 p-bottom-75" style={{maxWidth:"100%"}} >
                ...
                <div className="container">
                    <div className="row">
                        ...
                        <div className="col-lg-4 col-md-6 col-sm-6">
                                ...
                                <button onClick={onOpenModal}  data-toggle="modal" data-target="#modal-center">
                                    <img src="../assets/img/career1.png" alt="mothersfood"   className="img-responsive" style={{maxWidth:"100%"}}></img>
                                    </button>
                                </div>
        ...
        <Modal open={open} onClose={onCloseModal} center className="modal fade" id="modal-center" tabIndex={-1} role="dialog" aria-labelledby="modal-centerLabel" aria-hidden="true">
