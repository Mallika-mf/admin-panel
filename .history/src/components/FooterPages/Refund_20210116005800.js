           ...
           {/* <Header/> */}
            <section className="section-bg p-top-100 p-bottom-110">
                ...
                <div className="post-content">
                    ...
                    <div className="post-body">
                        ...
                        <div className="m-bottom-40">
                            <ul style={{marginLeft:"2%"}} className="bullet--list2">
                                ...
                                <ol style={{marginLeft:"2%"}} className="number-list number--list1">
                    ...
                    <div className="post-body">
                        <h4 style={{textAlign:"justify"}}><b>2. REFUNDS</b></h4>
                        <div className="m-bottom-40">
                        <ul style={{marginLeft:"2%"}} className="bullet--list2">
                                ...
                                <table className="table table-one">
                                        ...
                                        <tr>
                                        <td >
                                        <p style={{color:"white",textAlign:"justify"}}><strong>Process</strong></p>
                                        </td>
                                        <td >
                                        <p style={{color:"white",textAlign:"justify"}}><strong>Payment Method</strong></p>
                                        </td>
                                        <td >
                                        <p style={{color:"white",textAlign:"justify"}}><strong>Refund Source</strong></p>
                                        </td>
                                        <td >
                                        <p style={{color:"white",textAlign:"justify"}}><strong>TAT</strong></p>
                                        </td>
                                        </tr>
                                        </thead>
                                        <tbody>
                                        <tr>
                                        <td rowspan="10" >
                                        <p style={{textAlign:"justify",marginTop:"70%"}}>Order Edit/Cancellation/Compensation/Payment Failure</p>
                                        </td>
                                        <td >
                                        <p style={{textAlign:"justify"}}>Net Banking</p>
                                        </td>
                                        <td >
                                        <p style={{textAlign:"justify"}}>Source</p>
                                        </td>
                                        <td >
                                        <p style={{textAlign:"justify"}}>5-7 Business Days</p>
                                        </td>
                                        </tr>
                                        <tr>
                                        <td >
                                        <p style={{textAlign:"justify"}}>Debit/Credit Cards</p>
                                        </td>
                                        <td >
                                        <p style={{textAlign:"justify"}}>Source</p>
                                        </td>
                                        <td >
                                        <p style={{textAlign:"justify"}}>4-7 Business Days</p>
                                        </td>
                                        </tr>
                                        <tr>
                                        <td >
                                        ...
                                        <td >
                                        <p style={{textAlign:"justify"}}>2-4 Business Days</p>
                                        </td>
                                        </tr>
                                        <tr>
                                        <td >
                                        <p style={{textAlign:"justify"}}>Amazon Pay (Wallet)</p>
                                        </td>
                                        <td>
                                        <p style={{textAlign:"justify"}}>Source</p>
                                        </td>
                                        <td >
                                        <p style={{textAlign:"justify"}}>5 Business Days</p>
                                        </td>
                                        </tr>
                                        <tr>
                                        <td >
                                        <p style={{textAlign:"justify"}}>Amazon Pay (CC/DC/NB)</p>
                                        </td>
                                        <td>
                                        <p style={{textAlign:"justify"}}>Source</p>
                                        </td>
                                        ...
                                        <tr>
                                        <td >
                                        <p style={{textAlign:"justify"}}>Phone Pe (Wallet)</p>
                                        </td>
                                        <td>
                                        <p style={{textAlign:"justify"}}>Source</p>
                                        </td>
                                        ...
                                        <tr>
                                        <td >
                                        <p style={{textAlign:"justify"}}>Phone Pe (CC/DC/NB)</p>
                                        </td>
                                        <td>
                                        <p style={{textAlign:"justify"}}>Source</p>
                                        </td>
                                        ...
                                        <tr>
                                        <td >
                                        <p style={{textAlign:"justify"}}>Wallets-Paytm / Mobikwik /</p>
                                        <p style={{textAlign:"justify"}}>Freecharge</p>
                                        </td>
                                        <td>
                                        <p style={{textAlign:"justify"}}>Source</p>
                                        </td>
                    ...
                    <div className="post-body">
                        <h4 style={{textAlign:"justify",marginTop:"5%"}}><b>3. In case of payment at the time of delivery, you will not be required to pay for:</b></h4>
                        <div className="m-bottom-40">
                            <ul style={{marginLeft:"2%"}} className="bullet--list2">
