...
Sorry, your browser does not support inline SVG.</h1>
  ...
  <path fill="gray" fill-opacity="1" d="M0,192L40,181.3C80,171,160,149,240,128C320,107,400,85,480,96C560,107,640,149,720,176C800,203,880,213,960,197.3C1040,181,1120,139,1200,122.7C1280,107,1360,117,1400,122.7L1440,128L1440,320L1400,320C1360,320,1280,320,1200,320C1120,320,1040,320,960,320C880,320,800,320,720,320C640,320,560,320,480,320C400,320,320,320,240,320C160,320,80,320,40,320L0,320Z"></path>
<p>hie</p>
</svg>
            </div>
            <div>
            <section className="section pt-5 pb-3 products-section" style={{backgroundColor:"gray"}}>
