                    ...
                    <div className="row">
                        <div className="col-lg-12">
                            <div className="apply-form--header " >
                                <h3 style={{ textAlign: "justify" }}>Apply For This Position</h3>
                                <p style={{ textAlign: "justify" }}>Submit your resume below to apply for the job.</p>
                            </div>
                        </div>
                    </div>
                </div>
        ...
        <div className="col-lg-12">
          ...
          <form id="create-course-form">   
            <div className="form-group">
              ...
              <input type="text" name="fname" onChange={this.setStateFromInput} className="form-control" placeholder="First Name" />
            </div>{/* ends: .form-group */}
            <div className="form-group">
              <label>Last Name<span className="sup" style={{color:"red"}}>*</span></label>
              <input type="text" name="lname" onChange={this.setStateFromInput} className="form-control" placeholder="Last Name" />
            </div>{/* ends: .form-group */}
            <div className="form-group">
              <label>Email Address<span className="sup" style={{color:"red"}}>*</span></label>
              <input type="email" name="email" onChange={this.setStateFromInput} className="form-control" placeholder="Email" />
            </div>{/* ends: .form-group */}
            <div className="form-group">
              <label>Mobile Number<span className="sup" style={{color:"red"}}>*</span></label>
              <input type="text" name="mobilenumber" onChange={this.setStateFromInput} className="form-control" placeholder="Mobile Number" />
            </div>{/* ends: .form-group */}
            <div className="form-group">
              <label>Address <span className="sup" style={{color:"red"}}>*</span></label>
              <input type="text" name="address" onChange={this.setStateFromInput} className="form-control" placeholder="Address" />
            </div>{/* ends: .form-group */}
            <div className="form-group">
              <label>City <span className="sup" style={{color:"red"}}>*</span></label>
              <input type="text" name="city" className="form-control" onChange={this.setStateFromInput} placeholder="City" />
            </div>{/* ends: .form-group */}
            <div className="form-group">
            ...
            <div className="form-group">
              ...
              <input type="text" name="companyname" onChange={this.setStateFromInput} className="form-control" placeholder="Company Name" />
            </div>{/* ends: .form-group */}
            <div className="form-group">
              <label>Professional Title <span className="sup" style={{color:"red"}}>*</span></label>
              <input type="text" name="title" onChange={this.setStateFromInput} className="form-control" placeholder="e.g. Web Developer" />
            </div>{/* ends: .form-group */}
            <div className="form-group">
              <label>Skills <span className="optional">(Optional)</span> <span className="sup" style={{color:"red"}}>*</span></label>
              <input type="text" name="skills" className="form-control" onChange={this.setStateFromInput} placeholder="Comma separate a list of relevant skills" />
            </div>{/* ends: .form-group */}
            <div className="form-group">
            ...
            <div className="form-group">
              ...
              <input type="text" name="universityname" onChange={this.setStateFromInput} className="form-control" placeholder="University / School Name" />
            </div>{/* ends: .form-group */}
            <div className="form-group">
              <label>Degree Level <span className="sup" style={{color:"red"}}>*</span></label>
              <div className="select-basic" >
                <input type="text" name="degree" onChange={this.setStateFromInput} className="form-control" placeholder="Highest Degree Qualified" />
              </div>
            </div>{/* ends: .form-group */}
            <div className="form-group">
              <label>Grade Point Average <span className="sup" style={{color:"red"}}>*</span></label>
              <input type="text" name="gpa" onChange={this.setStateFromInput} className="form-control" required placeholder="Grade Point" />
            </div>{/* ends: .form-group */}
            <h4 className="border-bottom p-bottom-25 m-bottom-50 m-top-70">Add Resume<span className="sup" style={{color:"red"}}>*</span></h4>
            <div className="form-group">
              <div className="custom-upload">
                <input type="file" name="resume" ref={this.state.resume} onChange={this.resumeupload} className="custom-upload" required/>
                <div className="custom-upload-box d-flex">
                  <div className="upload-btn">
                    <a href=' ' className="btn btn-danger btn-icon icon-right" style={{background:"#E41C39",border:"#E41C39"}}>Choose Resume <i className="la la-cloud-upload" /></a>
                  </div>
            ...
            <input type="text" name="additional" onChange={this.setStateFromInput} className="form-control" placeholder="Any other information you want to tell us" />
