...
var yyyy1 = time.getFullYear();
    ...
    window.axios
      .post("https://liveyumfoods.xyz/ordersmothers.php?amount=" + parseFloat(4999).toFixed(2))
      .then(function (response) {
        // console.log(response.data);
   
        var options = {
          key: "rzp_live_hixZG1ClXcmfK5", // Enter the Key ID generated from the Dashboard
          amount: parseFloat(4999).toFixed(2), // Amount is in currency subunits. Default currency is INR. Hence, 50000 refers to 50000 paise or INR 500.
          currency: "INR",
          name: "Mothers Food",
          description: "",
