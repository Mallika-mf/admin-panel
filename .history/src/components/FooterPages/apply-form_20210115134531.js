      ...
      <div className="row">
        <div className="col-lg-12">
          ...
          <form id="create-course-form">   
            ...
            <span  className="btn btn-danger btn-icon icon-right" style={{background:"#E41C39",border:"#E41C39",height:"40px",marginRight:"20%"}}>Choose Resume <FontAwesome icon="fas fa-cloud-upload-alt" /></span>
            <span style={{marginLeft:"20%"}}>PDF,Docs </span>
                    <span style={{marginLeft:"60%"}} >Max File Size: 5Mb</span>         
      </label>
