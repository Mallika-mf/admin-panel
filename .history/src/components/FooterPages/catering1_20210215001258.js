  ...
  const options = {
    ...
    return (
      ...
      {isLoggedin === "true" ? <NavBarListing /> : <NavBarlisting2 />}
            ...
            <div className='card' style={{backgroundImage:`linear-gradient(rgba(0,0,0,0.6),rgba(0,0,0,0.6)),url('../assets/img/catering.jpg')`,    backgroundSize: "cover",marginRight:"-130px", textShadow: ".1em .1em rgba(0, 0, 0, 0.2)"}}>
