...
Sorry, your browser does not support inline SVG.</h1>
            ...
            <div className="intro-four bgimage" stylebackgroundImage:`linear-gradient(rgba(0,0,0,0.6),rgba(0,0,0,0.6)),url('../assets/img/cupcake2.jpg')`,    backgroundSize: "cover",marginRight:"-130px", textShadow: ".1em .1em rgba(0, 0, 0, 0.2)"}}>
