...
import ProductBox from "../home/ProductBox1";
  ...
  var isLoggedin = localStorage.getItem("isLogging");
    ...
    return (
      ...
      {isLoggedin === "true" ? <NavBarListing /> : <NavBarlisting2 />}
            ...
            <div className='card' style={{backgroundImage:`linear-gradient(rgba(0,0,0,0.6),rgba(0,0,0,0.6)),url('../assets/img/cupcake2.jpg')`,    backgroundSize: "cover",marginRight:"-130px", textShadow: ".1em .1em rgba(0, 0, 0, 0.2)"}}>
...
Sorry, your browser does not support inline SVG.</h1>
            ...
            <MDBContainer style={{ marginLeft: "0%" }}>
              ...
              >
                ...
                <a href="/contactus">Contact Us</a>
                            ...
                            <div className="col-4 homepage-banner-section"style={{marginTop:"4%"}}>
                            <div className="item">
                        <ProductBox
  ...
  <path fill="white" fill-opacity="1" d="M0,192L40,181.3C80,171,160,149,240,128C320,107,400,85,480,96C560,107,640,149,720,176C800,203,880,213,960,197.3C1040,181,1120,139,1200,122.7C1280,107,1360,117,1400,122.7L1440,128L1440,320L1400,320C1360,320,1280,320,1200,320C1120,320,1040,320,960,320C880,320,800,320,720,320C640,320,560,320,480,320C400,320,320,320,240,320C160,320,80,320,40,320L0,320Z"></path>
</svg>
            </div>
