    ...
    return (
        <Fragment>
            ...
            <div className="intro-four bgimage">
                <div className="intro-four--contents content_middle">
              ...
              >
                                        <MDBCardTitle
                                            ...
                                            style={{
                                                ...
                                                color: "#ffffcc",
                                                textShadow: "0 0 5px #fff, 0 0 10px #fff, 0 0 20px green, 0 0 30px green, 0 0 40px green, 0 0 55px green,   0 0 70px green"
                                            }}
                                        >
                                            Catering Service
                </MDBCardTitle>
