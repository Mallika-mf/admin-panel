...
Sorry, your browser does not support inline SVG.</h1>
        ...
        <svg xmlns="https://www.w3.org/2000/svg" viewBox="0 0 1440 320">
          <path fill="#ffe9ec" fill-opacity="1" d="M0,192L40,181.3C80,171,160,149,240,128C320,107,400,85,480,96C560,107,640,149,720,176C800,203,880,213,960,197.3C1040,181,1120,139,1200,122.7C1280,107,1360,117,1400,122.7L1440,128L1440,320L1400,320C1360,320,1280,320,1200,320C1120,320,1040,320,960,320C880,320,800,320,720,320C640,320,560,320,480,320C400,320,320,320,240,320C160,320,80,320,40,320L0,320Z"></path>
          <p>hie</p>
        </svg>
      </div>
      {/* <div>
      ...
      <div>
      {/* <section className="section pt-5 pb-2 products-section card" style={{ backgroundColor:"#ffe9ec" }}> */}
      <section className="section pt-5 pb-3 products-section" style={{ backgroundColor: "#ffe9ec" }}>
              ...
              <div className="post-body">
                <div className="m-bottom-40">
                  <ul className="bullet--list2" style={{ fontSize: "15px" }}>
                    ...
                    >
                      Catering is a seasonal business.We bring in clients in all seasons for your benefits
                      </li>
                    <li
                      style={{ textAlign: "justify", fontSize: "15px" }}
                      className="bullet_list"
                    >
                      By catering for smaller parties prospective clients give you more business.
                      </li>
                    <li
                      style={{ textAlign: "justify", fontSize: "15px" }}
                      className="bullet_list"
                    >
                      Food is a word of mouth business and hence some lip smacking food to a targeted audience always help to generate more revenue
                      </li>
                    <li
                      style={{ textAlign: "justify", fontSize: "15px" }}
                      className="bullet_list"
                    >
                      Having an automated process helps to keep a track for past orders and re-target them with new offers from caterers side
                      </li>
                    <li
                      style={{ textAlign: "justify", fontSize: "15px" }}
                      className="bullet_list"
                    >
                      In this era of technology an online presence with great customer reviews help build a trust among customers and makes you a step ahead then your competitors.
                      </li>
                    <li
                      style={{ textAlign: "justify", fontSize: "15px" }}
                      className="bullet_list"
      ...
      <section className="section pt-5 pb-5 products-section card"style={{ backgroundColor:"#ffe9ec" }}>
