									...
									{this.state.showPromocode === true ?
										<>
											<InputGroup className="input-group-sm mb-2">
												...
												<InputGroup.Append>
													<Button variant="primary" type="button" onClick={this.handlePromo} id="button-addon2" disabled={(this.state.promocode.length !== 0).toString()}><Icofont icon="sale-discount" /> APPLY</Button>
												</InputGroup.Append>
											</InputGroup>
										</> :
