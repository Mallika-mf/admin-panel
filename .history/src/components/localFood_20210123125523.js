	...
	loadVendors = async () => {
	  ...
	  applyFilter = () => {
		setTimeout(() => {
		  ...
		  let filteredProducts1 = this.allProducts;
		  ...
		  filteredProducts1 = this.sortProducts(filteredProducts1);
		  console.log(filteredProducts1);
		  this.setState({ product: { items: filteredProducts1, loading: false } });
		  this.setState({
			pages:
			  this.limit < filteredProducts1.length
				? Math.ceil(filteredProducts1.length / this.limit)
				: 1,
		  });
