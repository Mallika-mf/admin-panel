...
import { Row, Col, Container, Form, InputGroup, Button, Tab, Nav, Image, Badge ,Modal} from 'react-bootstrap';
					...
					<div className="restaurant-detailed-header">
						<Container>
							<Row className="d-flex align-items-end">
								<Col md={8}>
									<div className="restaurant-detailed-header-left" style={{marginTop:"10%"}}>
										{prd.PP === "https://firebasestorage.googleapis.com/v0/b/mothersfood-a1de8.appspot.com/o/CloudKitchen%2F1599912088639-add.png?alt=media&token=60561b4b-af5d-489c-bbc8-28e8de47851f" || prd.PP == "" ? <Image fluid className="mr-3 float-left" alt="osahan" src="/assets/img/chef.png" /> : <Image fluid className="mr-3 float-left" alt="osahan" style={{ width: '170px', height: '170px', borderRadius: '50%' }} src={prd.PP} />}
		                        	  ...
		                        	  <ItemsCarousel /> */}
			                              ...
			                              <Col md={12}>
			                                 <div className="bg-white rounded border shadow-sm mb-4">
												...
												<Row>
													<h5 className="mb-4 mt-3 col-md-12">Food Items <small className="h6 text-black-50">{foodItems.length} &nbsp;ITEMS</small></h5>
													<Col md={12}>
														<div className="bg-white rounded border shadow-sm mb-4">
