							...
							<Row className="d-flex align-items-end">
								<Col md={8}>
									<div className="restaurant-detailed-header-left" >
										{prd.PP === "https://firebasestorage.googleapis.com/v0/b/mothersfood-a1de8.appspot.com/o/CloudKitchen%2F1599912088639-add.png?alt=media&token=60561b4b-af5d-489c-bbc8-28e8de47851f" || prd.PP == "" ? <Image fluid className="mr-3 float-left" alt="osahan" src="/assets/img/chef.png" style={{marginTop:"10%"}} /> : <Image fluid className="mr-3 float-left" alt="osahan" style={{ width: '170px', height: '170px', borderRadius: '50%',marginTop:"10%" }} src={prd.PP} />}
