                                    ...
                                    <div className="widget-content">
                                        <div className="sidebar-post">
                                            <div className="d-flex align-items-center">
                                                <div className="col-lg-7"><NavLink to='/news-detail-1'><img src="../assets/img/blog-img-3.jpg" alt="mothersfood" style={{width:"100px"}} /></NavLink></div>
                                                <div className="col-lg-7"><p ><span >July 07, 2020</span> <br /><span>by <NavLink to='/' onClick={noAction}>Rikitha Ravula</NavLink></span></p></div>
                                            </div>
                                            <div style={{ position: "relative", marginLeft: "6.5%" }}>
