                            ...
                            <div className="widget-default">
                                    ...
                                    <div className="widget-content">
                                        <div className="sidebar-post">
                                            <div className="d-flex align-items-center">
                                                <div className="col-lg-6"><NavLink to='/news-detail-1'><img src="../assets/img/blog-img-3.jpg" alt="mothersfood" /></NavLink></div>
                                ...
                                <div class="row mx-md-n4">
                                    <div className="widget-content">
                                        <div className="sidebar-post">
                                            <div className="d-flex align-items-center">
                                                <div className="col-lg-6"><NavLink to='/news-detail-2'  ><img src="../assets/img/blog-img-1.jpg" alt="mothersfood" /></NavLink></div>
                                                <div className="col-lg-6"> <p><span>July 07, 2020</span> <br /><span>by <NavLink to='/' onClick={noAction}>Rikitha Ravula</NavLink></span></p></div>
                                            </div>
                                ...
                                <div class="row mx-md-n4">
                                    <div className="widget-content">
                                        <div className="sidebar-post">
                                            <div className="d-flex align-items-center">
                                                <div className="col-lg-6"><NavLink to='/news-detail-3'><img src="../assets/img/blog-img-2.jpg" alt="mothersfood" /></NavLink></div>
                                                <div className="col-lg-6"> <p><span>July 07, 2020</span> <br /><span>by <NavLink to='/' onClick={noAction}>Rikitha Ravula</NavLink></span></p></div>
                                            </div>
                                ...
                                <div class="row mx-md-n4">
                                    <div className="widget-content">
                                        <div className="sidebar-post">
                                            <div className="d-flex align-items-center">
                                                <div className="col-lg-6"><NavLink to='/news-detail-5'><img src="../assets/img/blog-img-5.jpg" alt="mothersfood" /></NavLink></div>
                                ...
                                <div class="row mx-md-n4">
                                    <div className="widget-content">
                                        <div className="sidebar-post">
                                            <div className="d-flex align-items-center">
                                                <div className="col-lg-6"><NavLink to='/news-detail-6'><img src="../assets/img/blog-img-6.jpg" alt="mothersfood" /></NavLink></div>
                                ...
                                <div class="row mx-md-n4">
                                    <div className="widget-content">
                                        <div className="sidebar-post">
                                            <div className="d-flex align-items-center">
                                                <div className="col-lg-6"><NavLink to='/news-detail-7'><img src="../assets/img/blog-img-7.jpg" alt="mothersfood" /></NavLink></div>
                                 ...
                                 <div class="row mx-md-n4">
                                    <div className="widget-content">
                                        <div className="sidebar-post">
                                            <div className="d-flex align-items-center">
                                                <div className="col-lg-6"><NavLink to='/news-detail-8'><img src="../assets/img/blog-img-8.jpg" alt="mothersfood" /></NavLink></div>
                                ...
                                <div class="row mx-md-n4">
                                    <div className="widget-content">
                                        <div className="sidebar-post">
                                            <div className="d-flex align-items-center">
                                                <div className="col-lg-6"><NavLink to='/news-detail-9'><img src="../assets/img/blog-img-9.jpg" alt="mothersfood" /></NavLink></div>
                                ...
                                <div class="row mx-md-n4">
                                    <div className="widget-content">
                                        <div className="sidebar-post">
                                            <div className="d-flex align-items-center">
                                                <div className="col-lg-6"><NavLink to='/news-detail-10'><img src="../assets/img/blog-img-10.jpg" alt="mothersfood" /></NavLink></div>
                                ...
                                <div class="row mx-md-n4">
                                    <div className="widget-content">
                                        <div className="sidebar-post">
                                            <div className="d-flex align-items-center">
                                                <div className="col-lg-6"><NavLink to='/news-detail-11'><img src="../assets/img/blog-img-11.jpeg" alt="mothersfood" /></NavLink></div>
                                ...
                                <div class="row mx-md-n4">
                                    <div className="widget-content">
                                        <div className="sidebar-post">
                                            <div className="d-flex align-items-center">
                                                <div className="col-lg-6"><NavLink to='/news-detail-12'><img src="../assets/img/blog-img-12.jpg" alt="mothersfood" /></NavLink></div>
                                ...
                                <div class="row mx-md-n4">
                                    <div className="widget-content">
                                        <div className="sidebar-post">
                                            <div className="d-flex align-items-center">
                                                <div className="col-lg-6"><NavLink to='/news-detail-13'><img src="../assets/img/blog-img-13.jpeg" alt="mothersfood" /></NavLink></div>
                                ...
                                <div class="row mx-md-n4">
                                    <div className="widget-content">
                                        <div className="sidebar-post">
                                            <div className="d-flex align-items-center">
                                                <div className="col-lg-6"><NavLink to='/news-detail-14'><img src="../assets/img/blog-img-14.jpeg" alt="mothersfood" /></NavLink></div>
