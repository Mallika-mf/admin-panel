      ...
      <div className="post-details">
        ...
        <div className="post-content" style={{ marginTop: "5%" }}>
          ...
          <div className="m-bottom-40">
            ...
            <p style={{ textAlign: "justify",fontSize: "15px" }}><b>1) Cook pre-planned gravy: </b></p>
            ...
            <p style={{ textAlign: "justify",fontSize: "15px" }}><b>2) Bhuna Masala: </b></p>
            ...
            <p style={{ textAlign: "justify",fontSize: "15px" }}><b>3) Chop and keep the vegetables ready: </b></p>
            ...
            <p style={{ textAlign: "justify",fontSize: "15px" }}><b>4) Keep Chutney, Acchar and Chilli-Garlic paste ready: </b></p>
...
<p style={{ textAlign: "justify",fontSize: "15px" }}><b>5) Keep roasted oats and muesli: </b></p>
...
<p style={{ textAlign: "justify",fontSize: "15px" }}><b>6) Boiled Chana or pulses: </b></p>
...
<p style={{ textAlign: "justify",fontSize: "15px" }}><b>7) Keeping and idli/dosa batter ready: </b></p>
...
<p style={{ textAlign: "justify",fontSize: "15px" }}><b>8) Cooked meat and eggs: </b></p>
