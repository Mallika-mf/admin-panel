  ...
  return (
    <Fragment>
      <div className="post-details">
        ...
        <p style={{ textAlign: "justify",fontSize: "14px" }}> If Food Ingredients could speak this is what they would say:</p>
        <p style={{ textAlign: "justify",fontSize: "20px" }}><b>1)Cooking Oil: </b></p>
