    ...
    <Fragment>
      <div className="post-details">
        ...
        <p style={{ textAlign: "justify",fontSize: "20px" }}><b>1) Pre-Eating:  </b></p>
            ...
            <p style={{ textAlign: "justify",fontSize: "20px" }}><b>2) Avoid Buffets:   </b></p>
            ...
            <p style={{ textAlign: "justify",fontSize: "20px" }}><b>3) Have Plenty of Water:   </b></p>
            ...
            <p style={{ textAlign: "justify",fontSize: "20px" }}><b>4)Skip Breadbasket:    </b></p>
...
<p style={{ textAlign: "justify",fontSize: "20px" }}><b>5) Carry Granola bars:    </b></p>
...
<p style={{ textAlign: "justify",fontSize: "20px" }}><b>6) Share the Meal:   </b></p>
...
<p style={{ textAlign: "justify",fontSize: "20px" }}><b>7) Avoid Aerated Drinks:    </b></p>
<p style={{ textAlign: "justify",marginLeft:"2%",fontSize: "14px" }}>
...
<p style={{ textAlign: "justify",fontSize: "20px" }}><b>8) Have More Appetizers:     </b></p>
<p style={{ textAlign: "justify",marginLeft:"2%",fontSize: "14px" }}>
...
<p style={{ textAlign: "justify",fontSize: "20px" }}><b>9) Skip Desserts:      </b></p>
<p style={{ textAlign: "justify",marginLeft:"2%",fontSize: "14px" }}>
...
<p style={{ textAlign: "justify",fontSize: "20px" }}><b>10)Order Healthy Food Options:     </b></p>
<p style={{ textAlign: "justify",marginLeft:"2%",fontSize: "14px" }}>
