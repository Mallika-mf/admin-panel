      ...
      <div className="post-details">
        ...
        <div className="post-content" style={{ marginTop: "5%" }}>
          ...
          <div className="m-bottom-40">
            ...
            <p style={{ textAlign: "justify",fontSize: "15px" }}><b>1) Soups:</b></p>
            ...
            <p style={{ textAlign: "justify",fontSize: "15px" }}><b>2) Salads:</b></p>
            ...
            <p style={{ textAlign: "justify" ,fontSize: "15px"}}><b>3) Omelette:</b></p>
            ...
            <p style={{ textAlign: "justify",fontSize: "15px" }}><b>4) Smoothies:</b></p>
            ...
            <p style={{ textAlign: "justify",fontSize: "15px" }}><b>5) Veggie Noodles:</b></p>
            <p style={{ textAlign: "justify",marginLeft:"2%",fontSize: "14px" }}>
            ...
            <p style={{ textAlign: "justify",fontSize: "15px" }}><b>6) Leafy vegetables as wraps:</b></p>
            <p style={{ textAlign: "justify",marginLeft:"2%",fontSize: "14px" }}>
            Veggie Noodles are so simple to make that one would never even know the difference in taste. Kids enjoy noodles and what best way to consume vegetables than to make noodles. Food as they say is an art and awakens our hunger when we say tasty food. They are an amazing way to replace noodle carbs by low carb vegetables. Zucchini noodles are the easiest to make and get cooked very easily using simple spices.
            ...
            <p style={{ textAlign: "justify",fontSize: "15px" }}><b>7) Grilled Veggies:</b></p>
            <p style={{ textAlign: "justify",marginLeft:"2%",fontSize: "14px" }}>
