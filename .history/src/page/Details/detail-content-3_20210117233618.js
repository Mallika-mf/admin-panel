    ...
    return (
        ...
        <div className="post-head" style={{marginLeft:"-5%"}}>
                <div className="post-audio">
                    <img src="../assets/img/blog-img-2.jpg" alt="mothersfood" style={{maxWidth:"100%",width:"700px"}}/>
                </div>
            </div>
            <div className="post-content" style={{marginTop:"5%"}}>
                <div className="post-header">
                    <h3><strong>Fast Food Vs. Homemade Food</strong></h3>
                ...
                <div className="m-bottom-40">
                    <p style={{ textAlign: "justify" }}>Sure, Fast food can be luring with its looks, aroma, and taste, but have you realized the oily platters,
                    unhygienic kitchen equipment, and rotten ingredients? Yes. That's what makes them tasty, and most
                    important unhealthy. We all have a myth that homemade food is not as delicious as street food. Well,
                    whoever said that surely didn't understand the homemade food well.<br /></p>
                    <p style={{ textAlign: "justify" }}>The battle between Homemade food and fast food is never-ending, but have you ever realized that we
                    can cook fast food at home, but all these so-called Fast food can't bring the taste and love-filled in the
                    homemade food? I understand how much ever I'd like to brag about the homemade food our part of the
                    tummy that craves fast food drags us the mind towards in a different way. But there's always a way to
                    tackle it. All you need to do is solely dedicate yourself to homemade food and turn to opt for healthy,
                    homemade, hygienic also, superb tasty food. Wondering how? Read through and find out.
                    <br /></p>
                    <p style={{ textAlign: "justify" }}>
                        ...
                        <br /></p>
                    <p style={{ textAlign: "justify" }}>But why are we having this discussion now?</p>
                    <p style={{ textAlign: "justify" }}>There is no other better time than this to discuss homemade food benefits when the world is suffering
                    ...
                    <br /></p>
                    <p style={{ textAlign: "justify" }}>Wait, wait, when we bragged so much about homemade food, we understand how we sometimes feel
