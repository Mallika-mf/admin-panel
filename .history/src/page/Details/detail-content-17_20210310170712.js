      ...
      <div className="post-details">
        ...
        <div className="post-content" style={{ marginTop: "5%" }}>
          ...
          <div className="m-bottom-40">
            ...
            <p style={{ textAlign: "justify",fontSize: "15px" }}><b>Benefits of Sprouting</b></p>
            ...
            <p style={{ textAlign: "justify",fontSize: "15px" }}><b>1.	They help in digestion</b></p>
            ...
            <p style={{ textAlign: "justify",fontSize: "15px" }}><b>2. Boosts blood circulation instantly.</b></p>
            ...
            <p style={{ textAlign: "justify",fontSize: "15px" }}><b>3. It Helps in weight loss</b></p>
            ...
            <p style={{ textAlign: "justify",fontSize: "15px" }}><b>4. Builds a strong immunity</b></p>
            <p style={{ textAlign: "justify",marginLeft:"2%",fontSize: "14px" }}>
            ...
            <p style={{ textAlign: "justify",fontSize: "15px" }}><b>5. Helps to strengthen Eye-sight:</b></p>
            <p style={{ textAlign: "justify",marginLeft:"2%",fontSize: "14px" }}>
            ...
            <p style={{ textAlign: "justify",fontSize: "15px" }}><b>6. Highly Beneficial for Heart:</b></p>
            <p style={{ textAlign: "justify",marginLeft:"2%",fontSize: "14px" }}>
            ...
            <p style={{ textAlign: "justify",fontSize: "15px" }}><b>7. It Helps reduce acidity:</b></p>
            <p style={{ textAlign: "justify",marginLeft:"2%",fontSize: "14px" }}>
            ...
            <p style={{ textAlign: "justify",fontSize: "15px" }}><b>8. Prevents premature ageing:</b></p>
            <p style={{ textAlign: "justify",marginLeft:"2%",fontSize: "14px" }}>
