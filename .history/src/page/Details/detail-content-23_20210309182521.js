    ...
    <Fragment>
      <div className="post-details">
        ...
        {/* <ul style={{ fontSize: "15px",textAlign: "justify" }} className="bullet--list2"><b>1)Cooking Oil: </b>
            ...
            <p style={{ textAlign: "justify" }}><b>2) Fresh Vegetables:  </b></p>
            ...
            <p style={{ textAlign: "justify" }}><b>3)Masalas:  </b></p>
            ...
            <p style={{ textAlign: "justify" }}><b>4)Grains:  </b></p>
...
<p style={{ textAlign: "justify" }}><b>5)Meat:  </b></p>
