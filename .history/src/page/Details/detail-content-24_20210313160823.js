    ...
    <Fragment>
      <div className="post-details">
        ...
        {/* <ul style={{ fontSize: "15px",textAlign: "justify" }} className="bullet--list2"><b>1)Cooking Oil: </b>
            ...
            <p style={{ textAlign: "justify",fontSize: "15px" }}><b>2) Stop buying junk food:  </b></p>
            ...
            <p style={{ textAlign: "justify",fontSize: "15px" }}><b>3) Shop wisely and with a list:  </b></p>
            ...
            <p style={{ textAlign: "justify",fontSize: "15px" }}><b>4) Plan your meals:   </b></p>
...
<p style={{ textAlign: "justify",fontSize: "15px" }}><b>6) Have smoothies:  </b></p>
