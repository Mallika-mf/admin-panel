      ...
      <div className="post-details">
        ...
        <div className="post-content" style={{ marginTop: "5%" }}>
          ...
          <div className="m-bottom-40">
            ...
            <p style={{ textAlign: "justify",fontSize: "14px" }}>-Heart Disorders</p>
            <p style={{ textAlign: "justify",fontSize: "14px" }}>-Cancer</p>
            <p style={{ textAlign: "justify",fontSize: "14px" }}>-Arthritis</p>
            <p style={{ textAlign: "justify",fontSize: "14px" }}>-Stroke</p>
            <p style={{ textAlign: "justify",fontSize: "14px" }}>-Immunity deficiency </p>
            <p style={{ textAlign: "justify",fontSize: "14px" }}>-Respiratory disorders</p>
            <p style={{ textAlign: "justify",fontSize: "14px" }}> Including Super-Foods in one's everyday diet is very essential. They are available in different types of foods. Here are 5 superfoods and the ways you can include them in your diet:<br/></p>
            <p style={{ textAlign: "justify",fontSize: "15px" }}><b>1)Nuts:</b></p>
            ...
            <p style={{ textAlign: "justify",fontSize: "15px" }}><b>2)Olive Oil:.</b></p>
            ...
            <p style={{ textAlign: "justify",fontSize: "15px" }}><b>3)Berries:</b></p>
            ...
            <p style={{ textAlign: "justify",fontSize: "15px" }}><b>4)Yogurt:</b></p>
            <p style={{ textAlign: "justify",marginLeft:"2%",fontSize: "14px" }}>
            ...
            <p style={{ textAlign: "justify",fontSize: "15px" }}><b>5) Flax Seeds:</b></p>
            <p style={{ textAlign: "justify",marginLeft:"2%",fontSize: "14px" }}>
