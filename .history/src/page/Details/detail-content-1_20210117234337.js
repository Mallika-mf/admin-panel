    ...
    return (
        <Fragment>
            <div className="post-details" style={{position:"relative"}}  >
                <div className="post-head" style={{marginLeft:"-5%",postion:"absolute"}}>
                    <div className="post-images" >
                        <img src="../assets/img/blog-img-3.jpg" alt="mothersfood" style={{maxWidth:"100%",width:"700px"}} />
                    </div>
                </div>
                <div className="post-content" style={{marginTop:"5%"}} >
                    <div className="post-header" >
                        <h3 style={{position:"relative",marginLeft:"-30%"}}><strong>Cooking is a passion for every woman</strong></h3>
