                    ...
                    <div className="sidebar" style={{marginTop:"5%"}}>
                        ...
                        <div className="widget-wrapper" >
                            <div className="widget-default" >
                                ...
                                <div className="widget-header" style={{outline:"1px solid gray"}}  >
                                    <h6 className="widget-title" >Popular Post</h6>
                                </div>
                                <div class="row mx-md-n5" style={{margin:"20%"}} >
                                    ...
                                    <div className="widget-content">
                                        <div className="sidebar-post">
                                            <div className="d-flex align-items-center">
                                                ...
                                                <div className="col-lg-8" style={{marginLeft:"-10%"}}> <p><span>July 07, 2020</span> <br /><span>by <NavLink to='/' onClick={noAction}>Rikitha Ravula</NavLink></span></p></div>
                                            </div>
                                    ...
                                    <div className="widget-content">
                                        <div className="sidebar-post">
                                            <div className="d-flex align-items-center">
                                                ...
                                                <div className="col-lg-8" style={{marginLeft:"-10%"}}> <p><span>Nov 30, 2020</span> <br /><span>by <NavLink to='/' onClick={noAction}>Rikitha Ravula</NavLink></span></p></div>
                                            </div>
                                    ...
                                    <div className="widget-content">
                                        <div className="sidebar-post">
                                            <div className="d-flex align-items-center">
                                                ...
                                                <div className="col-lg-8" style={{marginLeft:"-10%"}}> <p><span>Dec 05, 2020</span> <br /><span>by <NavLink to='/' onClick={noAction}>Rikitha Ravula</NavLink></span></p></div>
                                            </div>
                                    ...
                                    <div className="widget-content">
                                        <div className="sidebar-post">
                                            <div className="d-flex align-items-center">
                                                ...
                                                <div className="col-lg-8" style={{marginLeft:"-10%"}}> <p><span>Dec 14, 2020</span> <br /><span>by <NavLink to='/' onClick={noAction}>Rikitha Ravula</NavLink></span></p></div>
                                            </div>
                                    ...
                                    <div className="widget-content">
                                        <div className="sidebar-post">
                                            <div className="d-flex align-items-center">
                                                ...
                                                <div className="col-lg-8" style={{marginLeft:"-10%"}}> <p><span>Dec 18, 2020</span> <br /><span>by <NavLink to='/' onClick={noAction}>Rikitha Ravula</NavLink></span></p></div>
                                            </div>
                                            <div style={{ position: "relative", marginLeft: "-30%" }}>
                                    ...
                                    <div className="widget-content">
                                        <div className="sidebar-post">
                                            <div className="d-flex align-items-center">
                                                ...
                                                <div className="col-lg-8" style={{marginLeft:"-10%"}}> <p><span>Dec 24, 2020</span> <br /><span>by <NavLink to='/' onClick={noAction}>Rikitha Ravula</NavLink></span></p></div>
                                            </div>
                                    ...
                                    <div className="widget-content">
                                        <div className="sidebar-post">
                                            <div className="d-flex align-items-center">
                                                ...
                                                <div className="col-lg-8" style={{marginLeft:"-10%"}}> <p><span>Dec 29, 2020</span> <br /><span>by <NavLink to='/' onClick={noAction}>Rikitha Ravula</NavLink></span></p></div>
                                            </div>
                                            <div style={{ position: "relative", marginLeft: "-25%" }}>
                                    ...
                                    <div className="widget-content">
                                        <div className="sidebar-post">
                                            <div className="d-flex align-items-center">
                                                ...
                                                <div className="col-lg-8" style={{marginLeft:"-10%"}}> <p><span>Jan 02, 2021</span> <br /><span>by <NavLink to='/' onClick={noAction}>Rikitha Ravula</NavLink></span></p></div>
                                            </div>
                                    ...
                                    <div className="widget-content">
                                        <div className="sidebar-post">
                                            <div className="d-flex align-items-center">
                                                ...
                                                <div className="col-lg-8" style={{marginLeft:"-10%"}}> <p><span>Jan 06, 2021</span> <br /><span>by <NavLink to='/' onClick={noAction}>Rikitha Ravula</NavLink></span></p></div>
                                            </div>
                                    ...
                                    <div className="widget-content">
                                        <div className="sidebar-post">
                                            <div className="d-flex align-items-center">
                                                ...
                                                <div className="col-lg-8" style={{marginLeft:"-10%"}}> <p><span>Jan 09, 2021</span> <br /><span>by <NavLink to='/' onClick={noAction}>Rikitha Ravula</NavLink></span></p></div>
                                            </div>
                                            <div style={{ position: "relative", marginLeft: "-25%" }}>
                                    ...
                                    <div className="widget-content">
                                        <div className="sidebar-post">
                                            <div className="d-flex align-items-center">
                                                ...
                                                <div className="col-lg-8" style={{marginLeft:"-10%"}}> <p><span>Jan 13, 2021</span> <br /><span>by <NavLink to='/' onClick={noAction}>Rikitha Ravula</NavLink></span></p></div>
                                            </div>
                                            <div style={{ position: "relative", marginLeft: "-35%" }}>
