    ...
    if(userLocal != null && roleLocal !== "Yes"){
        ...
        if(userLocal.includes("order3")) {
          ...
          if(userLocal.includes("approvals1")) {
            const approvals1 =   {
              title: 'Chef Approvals', icon: ShoppingCart, type: 'link', badgeType: 'primary',path: `${process.env.PUBLIC_URL}/table/chef-approvals`
          ...
          if(userLocal.includes("approvals2")) {
            const approvals2 =   {
              title: 'Delivery Partner Approvals', icon: ShoppingCart, type: 'link', badgeType: 'primary',path: `${process.env.PUBLIC_URL}/table/deliveryPartner-approvals`
          ...
          if(userLocal.includes("approvals3")) {
            const approvals3 =   {
              title: 'Agency  Approvals', icon: ShoppingCart, type: 'link', badgeType: 'primary',path: `${process.env.PUBLIC_URL}/table/agency-approvals`
          ...
          if(userLocal.includes("approvals4")) {
            const approvals4 =   {
              title: 'Working Partner Approvals', icon: ShoppingCart, type: 'link', badgeType: 'primary',path: `${process.env.PUBLIC_URL}/table/workingPartner-approvals`
          ...
          if(userLocal.includes("approvals5")) {
            const approvals5 =   {
              title: 'Food Items  Approvals', icon: ShoppingCart, type: 'link', badgeType: 'primary',path: `${process.env.PUBLIC_URL}/table/FoodItems-approvals`
          ...
          if(userLocal.includes("approvals6")) {
            const approvals6 =   {
              title: 'Subscription  Approvals', icon: ShoppingCart, type: 'link', badgeType: 'primary',path: `${process.env.PUBLIC_URL}/table/Subscription-approvals`
          ...
          if(userLocal.includes("approvals7")) {
            const approvals7 =   {
              title: 'Preorder Approvals', icon: ShoppingCart, type: 'link', badgeType: 'primary',path: `${process.env.PUBLIC_URL}/table/TodaysOffer-approvals`
          ...
          if(userLocal.includes("approvals8")) {
            const approvals8 =   {
              title: 'Location Change Requests', icon: ShoppingCart, type: 'link', badgeType: 'primary',path: `${process.env.PUBLIC_URL}/table/LocalityChange-Requests`
          ...
          if(userLocal.includes("approvals9")) {
            const approvals9 =   {
              title: 'Bank Change Requests', icon: ShoppingCart, type: 'link', badgeType: 'primary',path: `${process.env.PUBLIC_URL}/table/BankChange-Request`
          ...
          if(userLocal.includes("approvals10")) {
            const approvals10 =   {
              title: 'Description Change Requests', icon: ShoppingCart, type: 'link', badgeType: 'primary',path: `${process.env.PUBLIC_URL}/table/CMS-Request`
          ...
          if(userLocal.includes("approvals11")) {
            const approvals11 =   {
              title: 'Chef Profile Photo Approval', icon: ShoppingCart, type: 'link', badgeType: 'primary',path: `${process.env.PUBLIC_URL}/table/CMS-Request`
