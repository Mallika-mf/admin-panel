...
var roleSession = window.sessionStorage.getItem('superadmin')
    ...
    if(userLocal != null && roleLocal !== "Yes"){
        ...
        if(userLocal.includes("order3")) {
          ...
          if(userLocal.includes("food@catering")) {
            const foodcatering =   {
              title: 'Add Catering Packages', icon: ShoppingCart, type: 'link', badgeType: 'primary',path: `${process.env.PUBLIC_URL}/table/add-catering-menu`
  
            }
            newData[newData.length -1].children.push(foodcatering)
          }
          if(userLocal.includes("cateringMenu")) {
            const cateringMenu =   {
              title: 'Add Menu Items', icon: ShoppingCart, type: 'link', badgeType: 'primary',path: `${process.env.PUBLIC_URL}/table/show-catering-list`
  
            }
            newData[newData.length -1].children.push(cateringMenu)
          }
        ...
        let newData = []
            ...
            if(userSession.includes("order3")) {
              ...
              if(userSession.includes("food@catering")) {
                const foodcatering =   {
                  title: 'Add Catering Packages', icon: ShoppingCart, type: 'link', badgeType: 'primary',path: `${process.env.PUBLIC_URL}/table/add-catering-menu`
              ...
              if(userSession.includes("cateringMenu")) {
                const cateringMenu =   {
                  title: 'Add Menu Items', icon: ShoppingCart, type: 'link', badgeType: 'primary',path: `${process.env.PUBLIC_URL}/table/show-catering-list`
